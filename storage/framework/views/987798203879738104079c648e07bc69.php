...
<head>
    ...
    tailwind.config = {
        theme: {
            extend: {
                colors: {
                    acad: {
                        blue: '<?php echo e(config('academy-theme.blue')); ?>',
                        blueDark: '<?php echo e(config('academy-theme.blue_dark')); ?>',
                        cyan: '<?php echo e(config('academy-theme.cyan')); ?>',
                        yellow: '<?php echo e(config('academy-theme.yellow')); ?>',
                        ink: '<?php echo e(config('academy-theme.ink')); ?>',
                        navy: '<?php echo e(config('academy-theme.navy')); ?>',
                        navyMid: '<?php echo e(config('academy-theme.navy_mid')); ?>',
                        neon: '<?php echo e(config('academy-theme.neon')); ?>',
                    },
                },
                fontFamily: {
    ...
    <style>
        ...
        #scroll-progress{position:fixed;top:0;left:0;width:0%;height:3px;background:linear-gradient(90deg,<?php echo e(config('academy-theme.yellow')); ?>,<?php echo e(config('academy-theme.blue')); ?>);z-index:100000;transition:width .1s linear}
...
<body class="font-sans text-white antialiased font-display" x-data="{ isSubmitting: false }">
        ...
        <section class="relative pt-10 sm:pt-14 pb-10 sm:pb-12 overflow-hidden">
            ...
            <div class="container-acad relative z-10">
                <nav class="reveal text-sm text-white/50 mb-6 flex items-center gap-2 flex-wrap" aria-label="مسار التنقل">
                    ...
                    <i class="fas fa-chevron-<?php echo e($isRtl ? 'left' : 'right'); ?> text-[8px] text-white/30"></i>
                    <a href="<?php echo e(route('public.courses')); ?>" class="hover:text-acad-yellow transition-colors"><?php echo e(__('public.courses')); ?></a>
                    <?php if(isset($course)): ?>
                        <i class="fas fa-chevron-<?php echo e($isRtl ? 'left' : 'right'); ?> text-[8px] text-white/30"></i>
                        <a href="<?php echo e(route('public.course.show', $course->id)); ?>" class="hover:text-acad-yellow transition-colors"><?php echo e(Str::limit($course->title ?? '', 36)); ?></a>
                    <?php endif; ?>
                    <i class="fas fa-chevron-<?php echo e($isRtl ? 'left' : 'right'); ?> text-[8px] text-white/30"></i>
                    <span class="text-acad-yellow font-semibold"><?php echo e(__('public.checkout_breadcrumb_current')); ?></span>
                </nav>

                <div class="checkout-steps reveal mb-8 lg:mb-10" aria-label="<?php echo e(__('public.checkout_steps_label')); ?>">
                    <div class="flex items-center gap-3 shrink-0">
                        ...
                        <div class="min-w-0">
                            <p class="text-xs font-bold text-emerald-300"><?php echo e(__('public.checkout_step_1_title')); ?></p>
                            <p class="text-[11px] text-white/45 leading-snug"><?php echo e(__('public.checkout_step_1_desc')); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-3 shrink-0">
                        ...
                        <div class="min-w-0">
                            <p class="text-xs font-bold text-acad-yellow"><?php echo e(__('public.checkout_step_2_title')); ?></p>
                            <p class="text-[11px] text-white/45 leading-snug"><?php echo e(__('public.checkout_step_2_desc')); ?></p>
                        </div>
                    </div>
                    <span class="checkout-step-connector" aria-hidden="true"></span>
                    <div class="flex items-center gap-3 shrink-0">
                        ...
                        <div class="min-w-0">
                            <p class="text-xs font-bold text-white/65"><?php echo e(__('public.checkout_step_3_title')); ?></p>
                            <p class="text-[11px] text-white/45 leading-snug"><?php echo e(__('public.checkout_step_3_desc')); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-10 items-center">
                    <div class="lg:col-span-3 reveal">
                        <span class="inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-xs sm:text-sm font-extrabold mb-5 glass-panel text-white border border-white/10">
                            ...
                            <?php echo e(__('public.secure_checkout_badge')); ?>

                        </span>
                        <h1 class="text-3xl sm:text-4xl lg:text-[2.65rem] font-black text-white leading-[1.15] mb-4">
                            <?php echo e(__('public.checkout_page_label')); ?>

                        </h1>
                        <p class="text-white/65 text-base sm:text-lg leading-relaxed max-w-2xl mb-6">
                            <?php echo e(__('public.checkout_hero_lead')); ?>

                            <span class="font-bold text-acad-yellow"><?php echo e($itemTitle); ?></span>
                        </p>
                        <div class="flex flex-wrap gap-3">
                            <span class="inline-flex items-center gap-2 px-4 py-2 rounded-xl glass-panel text-white/85 text-sm font-semibold">
                                ...
                                <?php echo e(__('public.checkout_trust_secure')); ?>

                            </span>
                            <span class="inline-flex items-center gap-2 px-4 py-2 rounded-xl glass-panel text-white/85 text-sm font-semibold">
                                <i class="fas fa-bolt text-acad-yellow"></i>
                                <?php echo e(__('public.checkout_trust_fast')); ?>
                    ...
                    <div class="lg:col-span-2 reveal">
                        <?php if($thumbUrl): ?>
                            <div class="glass-panel rounded-2xl overflow-hidden border border-white/12 aspect-[4/3] relative bg-[#152a4a]">
                                ...
                                <img src="<?php echo e($thumbUrl); ?>" alt="" class="absolute inset-0 w-full h-full object-cover media-thumb-img" width="480" height="360" loading="eager" decoding="async" onload="this.classList.add('is-loaded');this.previousElementSibling?.remove();">
                            </div>
                        <?php else: ?>
                            <div class="glass-panel rounded-2xl border border-white/12 p-8 flex flex-col justify-center min-h-[220px]">
                                ...
                                <p class="text-xl font-black text-white leading-snug"><?php echo e(Str::limit($itemTitle, 80)); ?></p>
                                <p class="text-sm text-white/50 mt-2"><?php echo e($course->academicSubject->name ?? ''); ?></p>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                        ...
                        <div class="reveal glass-panel sticky top-24 rounded-2xl p-6 sm:p-7 border border-white/12 shadow-xl">
                            <div class="flex items-center justify-between gap-3 mb-5 pb-5 border-b border-white/10">
                                <div class="flex items-center gap-3 min-w-0">
                                    ...
                                    <div class="min-w-0">
                                        <p class="text-[10px] font-bold text-white/40 uppercase tracking-wide"><?php echo e($appName); ?></p>
                                        <p class="text-xs text-white/55 truncate"><?php echo e(__('public.checkout_summary_subtitle')); ?></p>
                                    </div>
                                </div>
                            </div>
                            <h3 class="text-lg font-black text-white mb-5"><?php echo e(__('public.checkout_order_summary_title')); ?></h3>
                            <div class="flex items-start gap-4 mb-6 pb-6 border-b border-white/10">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-sm text-white/50 mt-1">
                                        <?php echo e($course->academicSubject->name ?? __('public.course_category_not_set')); ?>
                            ...
                            <div class="space-y-3 mb-6" id="checkout-pricing-summary"
                                ...
                                <?php if($isMonthlyCheckout): ?>
                                    <p class="text-xs font-semibold text-acad-cyan bg-acad-cyan/10 border border-acad-cyan/20 rounded-xl px-3 py-2">
                                        <i class="fas fa-calendar-check <?php echo e($isRtl ? 'ml-1' : 'mr-1'); ?>"></i>
                                        <?php echo e(__('public.checkout_monthly_notice')); ?>
                                    ...
                                    <label class="flex items-start gap-3 p-3 rounded-xl border border-white/10 bg-white/5 cursor-pointer">
                                        <input type="checkbox" name="auto_renew" value="1" class="mt-1 rounded border-white/30 text-acad-cyan focus:ring-acad-cyan"
                                               <?php echo e(old('auto_renew', '1') ? 'checked' : ''); ?>>
                                        <span class="text-sm text-white/80">
                                            <span class="font-semibold text-white block"><?php echo e(__('public.checkout_auto_renew_label')); ?></span>
                                            <span class="text-white/50 text-xs"><?php echo e(__('public.checkout_auto_renew_hint')); ?></span>
                                        </span>
                                    </label>
                                <?php endif; ?>
                                <div class="flex justify-between items-center text-sm">
                                    <span class="text-white/60"><?php echo e($isMonthlyCheckout ? __('public.checkout_monthly_price_label') : __('public.checkout_base_price_label')); ?></span>
                                    <span class="font-bold text-acad-yellow text-lg" id="sum-original">
                                        <?php echo e(number_format($baseCoursePrice, 2)); ?>

                                        <span class="text-white/45 text-sm font-medium"><?php echo e(__('public.currency_egp')); ?><?php if($isMonthlyCheckout): ?>/<?php echo e(__('public.per_month')); ?><?php endif; ?></span>
                                    </span>
                                </div>
                                ...
                                <div class="flex justify-between items-center pt-4 border-t border-white/10">
                                    ...
                                    <span class="text-2xl font-black text-acad-yellow" id="sum-final">
                                        ...
                                        <span class="text-white/45 text-base font-medium"><?php echo e(__('public.currency_egp')); ?></span>
                                    </span>
                                </div>
                            </div>
                            <ul class="space-y-3 text-sm text-white/65">
                                <?php if($isMonthlyCheckout): ?>
                                    <li class="flex items-center gap-3"><span class="w-8 h-8 rounded-lg bg-emerald-500/15 flex items-center justify-center text-emerald-300 shrink-0"><i class="fas fa-check text-xs"></i></span> <?php echo e(__('public.checkout_benefit_monthly_access')); ?></li>
                                    <li class="flex items-center gap-3"><span class="w-8 h-8 rounded-lg bg-emerald-500/15 flex items-center justify-center text-emerald-300 shrink-0"><i class="fas fa-sync-alt text-xs"></i></span> <?php echo e(__('public.checkout_benefit_renew_anytime')); ?></li>
                                <?php else: ?>
                                    <li class="flex items-center gap-3"><span class="w-8 h-8 rounded-lg bg-emerald-500/15 flex items-center justify-center text-emerald-300 shrink-0"><i class="fas fa-check text-xs"></i></span> <?php echo e(__('public.checkout_benefit_lifetime')); ?></li>
                                <?php endif; ?>
                                <li class="flex items-center gap-3"><span class="w-8 h-8 rounded-lg bg-emerald-500/15 flex items-center justify-center text-emerald-300 shrink-0"><i class="fas fa-check text-xs"></i></span> <?php echo e(__('public.checkout_benefit_certificate')); ?></li>
                                <li class="flex items-center gap-3"><span class="w-8 h-8 rounded-lg bg-emerald-500/15 flex items-center justify-center text-emerald-300 shrink-0"><i class="fas fa-check text-xs"></i></span> <?php echo e(__('public.checkout_benefit_support')); ?></li>
                            </ul>
                        </div>
                    </aside>
                    ...
                    <div class="lg:col-span-8 order-1 lg:order-2">
                        <div class="reveal glass-panel rounded-2xl p-6 sm:p-8 lg:p-9 border border-white/12 shadow-xl">
                            <div class="flex items-start gap-4 mb-8 pb-6 border-b border-white/10">
                                ...
                                <div>
                                    <h2 class="text-2xl sm:text-3xl font-black text-white leading-tight"><?php echo e(__('public.checkout_payment_section_title')); ?></h2>
                                    <p class="text-white/55 text-sm mt-2 max-w-xl leading-relaxed"><?php echo e(__('public.checkout_payment_section_desc')); ?></p>
                                </div>
                            </div>
                            ...
                            <?php if(session('success')): ?>
                                <div class="alert-box alert-success mb-6">
                                    ...
                                    <p class="flex-1"><?php echo e(session('success')); ?></p>
                                </div>
                            <?php endif; ?>
                            <?php if(session('info')): ?>
                                <div class="alert-box alert-info mb-6">
                                    <i class="fas fa-info-circle"></i>
                                    <p class="flex-1"><?php echo e(session('info')); ?></p>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="mb-8 rounded-2xl border border-white/12 bg-white/[0.04] p-5 sm:p-6 space-y-4"
                                    ...
                                    <?php if($checkoutHasWalletBalance): ?>
                                        <p class="text-xs font-semibold text-acad-cyan">رصيد محفظتك الحالي: <?php echo e(number_format($studentWalletBalance, 2)); ?> <?php echo e(__('public.currency_egp')); ?></p>
                                    <?php endif; ?>
                            ...
                            <?php if($fawaterakMis): ?>
                                ...
                                <a href="<?php echo e(route('orders.index')); ?>" class="btn-acad-ghost">
                            ...
                            <?php else: ?>
                                ...
                                <form action="<?php echo e(route('public.course.checkout.complete', $course->id)); ?>" method="POST" enctype="multipart/form-data" @submit="isSubmitting = true" x-data="{paymentMethod:'bank_transfer'}" id="manual-checkout-form">
                                    <?php echo csrf_field(); ?>
    ...
    (function(){
        ...
        function updateSummary(data) {
            ...
            var monthSuffix = isMonthly ? ' / <?php echo e(__('public.per_month')); ?>' : '';
            var egpSmall = ' <span class="text-white/45 text-sm font-medium"><?php echo e(__('public.currency_egp')); ?></span>' + (isMonthly ? ' <span class="text-white/40 text-xs font-medium">/<?php echo e(__('public.per_month')); ?></span>' : '');
            var egpLarge = ' <span class="text-white/45 text-base font-medium"><?php echo e(__('public.currency_egp')); ?></span>' + (isMonthly ? ' <span class="text-white/40 text-sm font-medium">/<?php echo e(__('public.per_month')); ?></span>' : '');
            if (!data || !data.ok) {
    ...
    <?php if(!empty($fawaterakUseGateway) && empty($fawaterakMisconfigured) && ($fawaterakIntegration ?? 'iframe') === 'iframe'): ?>
    <script>
    (function(){
    ...
    <?php if(!empty($fawaterakUseGateway) && empty($fawaterakMisconfigured) && ($fawaterakIntegration ?? 'iframe') === 'api'): ?>
    <script>
    (function(){
        var prepareUrl = <?php echo json_encode(route('public.course.checkout.fawaterak.prepare', $course->id), 512) ?>;
...
<?php /**PATH C:\xampp\htdocs\glottical\resources\views\public\checkout.blade.php ENDPATH**/ ?>