        ...
        <div class="flex justify-between items-center h-24">
            ...
            <div class="flex items-center space-x-4 space-x-reverse">
                <a href="<?php echo e(route('home')); ?>" class="flex items-center space-x-4 space-x-reverse">
                    ...
                    <div>
                        <h1 class="text-2xl font-black text-blue-900 text-glow"><?php echo e(config('app.name', 'Glottical')); ?></h1>
                        <p class="text-sm text-blue-700 font-medium"><?php echo e(__('landing.nav.brand')); ?></p>
                        <p class="text-xs text-blue-600"><?php echo e(__('landing.hero.headline')); ?></p>
                    </div>
                </a>
            </div>
...
<?php /**PATH C:\xampp\htdocs\glottical\resources\views\components\public-navbar.blade.php ENDPATH**/ ?>