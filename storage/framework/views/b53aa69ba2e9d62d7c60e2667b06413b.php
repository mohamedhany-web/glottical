            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-sky-50 to-slate-50">
                    <h2 class="text-lg font-bold text-gray-900 flex items-center gap-2">
                        ...
                        <?php echo e($order->academic_year_id && ! $order->advanced_course_id ? 'طلب قديم' : __('student.course_info')); ?>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <div class="w-full sm:w-24 h-24 bg-gradient-to-br from-sky-500 to-sky-600 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg">
                            <?php if($order->course && $order->course->thumbnail): ?>
                                <img src="<?php echo e(storage_asset($order->course->thumbnail)); ?>" alt="<?php echo e($order->course->title ?? 'كورس'); ?>" 
                        ...
                        <div class="flex-1">
                            <?php if($order->academic_year_id && ! $order->advanced_course_id): ?>
                                <h3 class="text-lg font-bold text-gray-900 mb-2"><?php echo e($order->learningPath->name ?? 'طلب قديم'); ?></h3>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\student\orders\show.blade.php ENDPATH**/ ?>