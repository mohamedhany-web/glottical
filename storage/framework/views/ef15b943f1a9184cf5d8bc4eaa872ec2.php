<?php $__env->startSection('title', 'المدفوعات - التقارير المحاسبية - Glottical'); ?>
<?php $__env->startSection('page_title', 'المدفوعات'); ?>
...
<div class="space-y-5">
    <section class="flex flex-wrap items-end justify-between gap-4">
        ...
        <div class="admin-hero-actions flex flex-wrap gap-2">
            <a href="<?php echo e(route('admin.accounting.reports.export', array_merge(request()->query(), ['type' => 'payments']))); ?>"
    ...
    <article class="overflow-hidden rounded-2xl border border-line bg-surface shadow-soft">
        ...
        <form method="GET" action="<?php echo e(route('admin.accounting.reports.payments')); ?>" class="grid grid-cols-1 gap-4 p-4 sm:p-5 md:grid-cols-2 xl:grid-cols-4 xl:items-end">
            <div>
                ...
                <tbody class="divide-y divide-line">
                    <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="hover:bg-canvas/40">
                            ...
                            <td class="px-4 py-3 text-xs tabular-nums text-muted"><?php echo e($payment->created_at->format('Y-m-d H:i')); ?></td>
                        </tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\admin\accounting\reports-payments.blade.php ENDPATH**/ ?>