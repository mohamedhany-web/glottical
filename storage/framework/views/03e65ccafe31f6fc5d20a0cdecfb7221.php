...
<div class="space-y-4">
  ...
  <?php if($role === 'marketing'): ?>
    <div class="flex flex-wrap justify-end gap-2">
      <a href="<?php echo e(route('employee.crm.marketing.desk')); ?>" class="px-4 py-2 rounded-xl bg-teal-50 border border-teal-200 text-teal-900 text-sm font-bold">لوحة المسوق بالعمولة</a>
  ...
  <?php if($role === 'sales'): ?>
    <div class="flex justify-end">
      <a href="<?php echo e(route('employee.crm.marketing-inbox.index')); ?>" class="px-4 py-2 rounded-xl bg-emerald-600 text-white text-sm font-bold">صندوق بيانات المسوقين</a>
    </div>
  <?php endif; ?>
        ...
        <tbody class="divide-y">
          <?php $__empty_1 = true; $__currentLoopData = $leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
              ...
              <td class="px-4 py-3 text-gray-600"><?php echo e($lead->interestedCourse?->title ?? '—'); ?></td>
              <?php if($role !== 'marketing'): ?>
