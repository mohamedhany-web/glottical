<div class="flex flex-col h-full">
    ...
    <div class="sidebar-logo flex items-center gap-3 px-6">
        ...
        <div>
            <h2 class="text-lg font-black text-gray-900"><?php echo e(config('app.name')); ?></h2>
            <p class="text-xs text-gray-500"><?php echo e(config('app.name')); ?></p>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\glottical\resources\views\layouts\modern-sidebar.blade.php ENDPATH**/ ?>