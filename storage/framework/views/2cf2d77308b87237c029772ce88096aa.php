...
<?php $__env->startSection('title', 'تفاصيل اتفاقية الموظف - ' . config('app.name')); ?>
                            ...
                            <tr class="hover:bg-slate-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <?php if($payment->status === 'paid' && $payment->transfer_receipt_path): ?>
                                        <a href="<?php echo e(storage_asset($payment->transfer_receipt_path)); ?>" target="_blank" class="block text-xs text-blue-600 hover:underline mt-1"><i class="fas fa-receipt mr-1"></i>الإيصال</a>
                                    <?php endif; ?>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\admin\employee-agreements\show.blade.php ENDPATH**/ ?>