...
<div class="space-y-5 pb-8">
    <section class="flex flex-wrap items-end justify-between gap-4">
        ...
        <a href="<?php echo e(route('home')); ?>" target="_blank" rel="noopener" class="btn-press inline-flex h-9 items-center gap-2 rounded-xl border border-line bg-surface px-4 text-sm font-medium text-ink-soft transition hover:border-accent/30 hover:text-accent">
    ...
    <section class="admin-kpi-grid grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        <article class="rounded-2xl border border-line bg-surface p-4 shadow-soft">
            ...
            <p class="mt-1 text-sm font-semibold text-ink"><?php echo e($adminPanelLogoUrl ? 'مرفوع' : 'افتراضي (G)'); ?></p>
        </article>
        <article class="rounded-2xl border border-line bg-surface p-4 shadow-soft">
            <div class="inline-flex size-9 items-center justify-center rounded-xl <?php echo e($fawaterakGatewayEnabled ? 'bg-accent-soft text-accent' : 'bg-canvas-muted text-muted'); ?>">
                <i class="fas fa-credit-card text-sm"></i>
            </div>
            <p class="mt-3 text-xs text-muted">بوابة فواتيرك</p>
            <p class="mt-1">
                <span class="inline-flex items-center rounded-lg px-2.5 py-1 text-xs font-semibold <?php echo e($fawaterakGatewayEnabled ? 'bg-accent-soft text-accent' : 'bg-canvas-muted text-muted'); ?>">
                    <?php echo e($fawaterakGatewayEnabled ? 'مفعّل' : 'معطّل'); ?>

                </span>
            </p>
        </article>
        <article class="rounded-2xl border border-line bg-surface p-4 shadow-soft">
            <div class="inline-flex size-9 items-center justify-center rounded-xl <?php echo e($fawaterakEnvConfigured ? 'bg-accent-soft text-accent' : 'bg-metal/15 text-metal'); ?>">
                <i class="fas fa-key text-sm"></i>
            </div>
            <p class="mt-3 text-xs text-muted">مفاتيح API</p>
            <p class="mt-1 text-sm font-semibold text-ink"><?php echo e($fawaterakEnvConfigured ? 'مضبوطة' : 'غير مكتملة'); ?></p>
        </article>
        <article class="rounded-2xl border border-line bg-surface p-4 shadow-soft">
            <div class="inline-flex size-9 items-center justify-center rounded-xl <?php echo e($adminTwoFactorRequired ? 'bg-accent-soft text-accent' : 'bg-canvas-muted text-muted'); ?>">
                <i class="fas fa-shield-alt text-sm"></i>
            </div>
            <p class="mt-3 text-xs text-muted">المصادقة الثنائية</p>
            <p class="mt-1">
                <span class="inline-flex items-center rounded-lg px-2.5 py-1 text-xs font-semibold <?php echo e($adminTwoFactorRequired ? 'bg-accent-soft text-accent' : 'bg-canvas-muted text-muted'); ?>">
                    <?php echo e($adminTwoFactorRequired ? 'مفعّل' : 'غير مفعّل'); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <article class="<?php echo e($panel); ?>">
            ...
            <div class="<?php echo e($sectionBody); ?>">
                ...
                <div class="rounded-xl border px-4 py-3 text-xs leading-7 sm:text-sm <?php echo e($fawaterakEnvConfigured ? 'border-accent/20 bg-accent-soft text-accent' : 'border-metal/30 bg-canvas text-ink'); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="sticky bottom-4 z-10 flex flex-wrap items-center gap-3">
            ...
            <a href="<?php echo e(route('home')); ?>" target="_blank" rel="noopener" class="btn-press inline-flex h-11 items-center gap-2 rounded-xl border border-line bg-surface px-5 text-sm font-medium text-ink-soft transition hover:border-accent/30 hover:text-accent">
