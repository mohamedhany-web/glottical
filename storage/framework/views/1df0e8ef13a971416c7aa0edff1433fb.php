<div class="flex flex-col h-full">
    ...
    <div class="px-4 py-5 flex-shrink-0 border-b border-slate-200 dark:border-slate-600">
        <div class="sidebar-logo flex items-center gap-3">
            ...
            <div class="w-9 h-9 rounded-[10px] flex items-center justify-center flex-shrink-0 overflow-hidden bg-white dark:bg-slate-800 border border-slate-200/80 dark:border-slate-600 shadow-sm">
                <img src="<?php echo e($adminPanelLogoUrl); ?>" alt="" width="36" height="36" class="w-full h-full object-contain p-0.5" onerror="this.onerror=null;this.src='<?php echo e(\App\Services\AdminPanelBranding::inlineFallbackDataUri()); ?>';">
            </div>
            <?php else: ?>
            ...
            <div class="sidebar-logo-text">
                <h2 class="text-sm font-heading font-bold text-slate-800 dark:text-slate-100 tracking-tight leading-tight"><?php echo e(config('app.name')); ?></h2>
    ...
    <nav class="flex-1 px-3 py-4 overflow-y-auto sidebar-nav" style="min-height: 0;">
        <ul class="space-y-0.5">
            ...
            <li>
                <a href="<?php echo e(route('admin.homepage-sliders.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.homepage-sliders.*') ? 'active' : ''); ?>">
            ...
            <li x-data="{ open: <?php echo e($studentControlOpen ? 'true' : 'false'); ?> }">
                ...
                <ul x-show="open" x-transition class="mt-1 mr-3 space-y-0.5 border-r border-slate-200 pr-3">
                    ...
                    <?php endif; ?>
                    <?php if(($isFull || $u->hasPermission('manage.enrollments')) && Route::has('admin.learning-path-enrollments.index')): ?>
                    <li>
                        <a href="<?php echo e(route('admin.learning-path-enrollments.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.learning-path-enrollments.*') ? 'active' : ''); ?>">
            ...
            <?php $salesSectionOpen = request()->routeIs('admin.orders.*') || request()->routeIs('admin.sales.index') || request()->routeIs('admin.sales.leads.*') || request()->routeIs('admin.crm.*') || request()->routeIs('admin.coupons.*') || request()->routeIs('admin.coupon-commissions.*') || request()->routeIs('admin.referrals.*') || request()->routeIs('admin.referral-programs.*'); ?>
