                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <img src="<?php echo e(storage_asset($package->thumbnail)); ?>" alt="<?php echo e($package->name); ?>" class="w-12 h-12 rounded-lg object-cover">
                                            <?php else: ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\admin\packages\index.blade.php ENDPATH**/ ?>