<?php $__env->startSection('title', 'تعديل خطة التقسيط - ' . config('app.name')); ?>
<?php $__env->startSection('page_title', 'تعديل خطة التقسيط'); ?>
...
<div class="space-y-5">
    <section class="flex flex-wrap items-end justify-between gap-4">
        ...
        <div class="admin-hero-actions flex flex-wrap gap-2">
            <a href="<?php echo e(route('admin.installments.plans.show', $plan)); ?>" class="btn-press inline-flex h-9 items-center gap-2 rounded-xl border border-line bg-surface px-4 text-sm font-medium text-ink-soft transition hover:border-accent/30 hover:text-accent">
    ...
    <div class="mx-auto max-w-4xl">
        <article class="overflow-hidden rounded-2xl border border-line bg-surface shadow-soft">
            ...
            <form action="<?php echo e(route('admin.installments.plans.update', $plan)); ?>" method="POST" class="space-y-6 p-4 sm:p-5">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="<?php echo e(old('name', $plan->name)); ?>" required class="<?php echo e($fieldClass); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="3" class="<?php echo e($areaClass); ?>" placeholder="أضف تفاصيل توضيحية إضافية عن خطة التقسيط"><?php echo e(old('description', $plan->description)); ?></textarea>
                ...
                <div class="rounded-xl border border-line bg-canvas/40 p-4 sm:p-5">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" step="0.01" min="0" id="total_amount" name="total_amount" value="<?php echo e(old('total_amount', $plan->total_amount)); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" step="0.01" min="0" id="deposit_amount" name="deposit_amount" value="<?php echo e(old('deposit_amount', $plan->deposit_amount)); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" min="1" max="36" id="installments_count" name="installments_count" value="<?php echo e(old('installments_count', $plan->installments_count)); ?>" required class="<?php echo e($fieldClass); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" min="1" max="12" id="frequency_interval" name="frequency_interval" value="<?php echo e(old('frequency_interval', $plan->frequency_interval)); ?>" required class="<?php echo e($fieldClass); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" min="0" max="30" id="grace_period_days" name="grace_period_days" value="<?php echo e(old('grace_period_days', $plan->grace_period_days)); ?>" class="<?php echo e($fieldClass); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <label class="inline-flex items-center gap-3 text-sm font-medium text-ink">
                        <input type="checkbox" name="auto_generate_on_enrollment" value="1" <?php echo e(old('auto_generate_on_enrollment', $plan->auto_generate_on_enrollment) ? 'checked' : ''); ?> class="rounded border-line text-accent focus:ring-accent/20">
                        إنشاء جدول الأقساط تلقائيًا عند تفعيل التسجيل
                    </label>
                    <label class="inline-flex items-center gap-3 text-sm font-medium text-ink">
                        <input type="checkbox" name="is_active" value="1" <?php echo e(old('is_active', $plan->is_active) ? 'checked' : ''); ?> class="rounded border-line text-accent focus:ring-accent/20">
                        تفعيل الخطة فورًا
                    </label>
                </div>

                <div class="flex flex-wrap items-center justify-end gap-2 border-t border-line pt-5">
                    <a href="<?php echo e(route('admin.installments.plans.show', $plan)); ?>" class="btn-press inline-flex h-11 items-center rounded-xl border border-line px-5 text-sm font-medium text-ink transition hover:bg-canvas">إلغاء</a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\admin\installments\plans\edit.blade.php ENDPATH**/ ?>