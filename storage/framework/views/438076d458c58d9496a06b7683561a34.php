            ...
            <div class="flex flex-col gap-2 justify-end">
                <div class="flex flex-wrap items-center gap-3">
                    <label class="inline-flex items-center gap-2 text-sm text-gray-700">
                        <input type="checkbox" name="mine" value="1" <?php echo e(request('mine') && ! request('unassigned') ? 'checked' : ''); ?>
                    ...
                    <label class="inline-flex items-center gap-2 text-sm text-gray-700">
                        <input type="checkbox" name="unassigned" value="1" <?php echo e(request('unassigned') && ! request('mine') ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.employee', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\employee\sales\orders-index.blade.php ENDPATH**/ ?>