...
<div class="space-y-6">
  ...
  <?php if(isset($stats['subscriptions'])): ?>
    <div class="rounded-xl border border-teal-200 bg-teal-50 p-4 flex flex-wrap items-center justify-between gap-3">
      <div class="text-sm text-teal-900"><span class="font-bold">اشتركوا من عملائي:</span> <?php echo e(number_format($stats['subscriptions'])); ?> — عمولة: <strong><?php echo e(number_format($stats['my_commissions'] ?? 0, 2)); ?> ج.م</strong></div>
      <a href="<?php echo e(route('employee.crm.marketing.desk')); ?>" class="text-sm font-bold text-teal-800 underline">لوحة المسوق بالعمولة ←</a>
    </div>
  <?php elseif(isset($stats['my_commissions'])): ?>
  ...
  <?php if(($role ?? null) === 'sales'): ?>
    <div class="rounded-xl border border-emerald-200 bg-emerald-50 p-4 flex flex-wrap justify-between gap-3 items-center text-sm">
      ...
      <a href="<?php echo e(route('employee.crm.marketing-inbox.index')); ?>" class="font-bold text-emerald-800 underline">صندوق المسوقين ←</a>
    </div>
  <?php endif; ?>
