...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-slate-800/95 rounded-xl p-5 border border-gray-200 dark:border-slate-700 shadow-sm">
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
            ...
            <a href="<?php echo e(route('public.courses')); ?>" class="inline-flex items-center justify-center gap-2 bg-sky-500 hover:bg-sky-600 text-white px-5 py-3 rounded-xl text-sm font-bold transition-colors shadow-md w-full sm:w-auto">
                <i class="fas fa-th-large"></i>
                <?php echo e(__('student.browse_courses')); ?>

            </a>
            <?php if(Route::has('student.my-course-subscriptions')): ?>
            <a href="<?php echo e(route('student.my-course-subscriptions')); ?>" class="inline-flex items-center justify-center gap-2 border border-emerald-200 dark:border-emerald-800 text-emerald-700 dark:text-emerald-300 bg-emerald-50 dark:bg-emerald-950/30 hover:bg-emerald-100 px-5 py-3 rounded-xl text-sm font-bold transition-colors w-full sm:w-auto">
                <i class="fas fa-calendar-check"></i>
                <?php echo e(__('student.course_subscriptions_nav')); ?>
            ...
            <a href="<?php echo e(route('my-courses.show', $course)); ?>" class="course-card block">
                <div class="course-thumbnail h-36 bg-sky-100 flex items-center justify-center relative">
                    <?php if($course->thumbnail): ?>
                        <img src="<?php echo e(storage_asset($course->thumbnail)); ?>" alt="<?php echo e($course->title); ?>" class="w-full h-full object-cover">
                    <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\student\my-courses\index.blade.php ENDPATH**/ ?>