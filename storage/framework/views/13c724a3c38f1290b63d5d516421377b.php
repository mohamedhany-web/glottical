<?php $__env->startSection('title', 'تفاصيل الرسالة - Glottical'); ?>
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div>
                ...
                <p class="text-gray-600">
                    <?php echo e(__('عرض تفاصيل الرسالة المرسلة عبر منصة Glottical (بريد إلكتروني / قنوات أخرى)')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\admin\messages\show.blade.php ENDPATH**/ ?>