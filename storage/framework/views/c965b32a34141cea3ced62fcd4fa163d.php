<?php $__env->startSection('title', __('instructor.submissions_of') . ': ' . $assignment->title . ' - ' . config('app.name')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\instructor\assignments\submissions.blade.php ENDPATH**/ ?>