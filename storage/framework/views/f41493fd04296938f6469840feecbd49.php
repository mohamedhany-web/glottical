...
<?php $__env->startSection('meta_description', 'شهادات ' . config('app.name') . ' — وثّق مهاراتك اللغوية والمهنية وتحقق من صحة شهادتك.'); ?>
<?php $__env->startSection('meta_keywords', 'شهادات, Glottical, شهادة إتمام, سوق العمل'); ?>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\public\certificates.blade.php ENDPATH**/ ?>