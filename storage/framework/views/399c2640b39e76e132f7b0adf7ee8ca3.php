...
<?php elseif($promo): ?>
    <span <?php echo e($attributes->class(['inline-flex flex-col items-end gap-0.5'])); ?>>
        <span class="<?php echo e($small ? 'text-[10px]' : 'text-xs'); ?> text-slate-400 line-through tabular-nums"><?php echo e(number_format($list, 0)); ?> <?php echo e(__('public.currency_egp')); ?><?php if($isMonthly): ?>/<?php echo e($perMonth); ?><?php endif; ?></span>
        <span class="<?php echo e($small ? 'text-xs font-bold' : 'text-sm font-black'); ?> text-mx-orange tabular-nums"><?php echo e(number_format($pay, 0)); ?> <?php echo e(__('public.currency_egp')); ?><?php if($isMonthly): ?>/<?php echo e($perMonth); ?><?php endif; ?></span>
    </span>
<?php else: ?>
    <span <?php echo e($attributes->class(['font-bold text-mx-orange tabular-nums', $small ? 'text-xs' : 'text-sm'])); ?>>
        <?php echo e(number_format($pay, 0)); ?> <?php echo e(__('public.currency_egp')); ?><?php if($isMonthly): ?>/<?php echo e($perMonth); ?><?php endif; ?>
    </span>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\glottical\resources\views\components\advanced-course-card-price.blade.php ENDPATH**/ ?>