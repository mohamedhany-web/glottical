...
<style>
    ...
    .btn-stream-primary {
        ...
        border-radius: 1rem;
        font-weight: 800;
        color: <?php echo e(config('academy-theme.blue')); ?>;
        background: <?php echo e(config('academy-theme.yellow')); ?>;
        transition: transform 0.2s ease, filter 0.2s ease, box-shadow 0.2s ease;
    }
    .btn-stream-primary:hover {
        transform: translateY(-1px) scale(1.02);
        filter: brightness(1.05);
        box-shadow: 0 18px 40px -18px rgba(<?php echo e(config('academy-theme.yellow_rgb')); ?>, 0.55);
    }
...
<?php /**PATH C:\xampp\htdocs\glottical\resources\views\partials\public-academy-surface.blade.php ENDPATH**/ ?>