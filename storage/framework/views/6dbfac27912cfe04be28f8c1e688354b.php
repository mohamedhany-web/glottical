<div class="flex flex-col h-full">
    ...
    <nav class="flex-1 overflow-y-auto sidebar-scroll px-0 py-2 space-y-0.5 min-h-0">
        ...
        <?php if($isInstructor || $user->hasAnyPermission('instructor.view.courses', 'instructor.manage.lectures', 'instructor.manage.assignments', 'instructor.manage.exams', 'instructor.manage.attendance', 'instructor.view.tasks')): ?>
            ...
            <?php endif; ?>
            <?php if(Route::has('instructor.one-to-one-sessions.index')): ?>
            <a href="<?php echo e(route('instructor.one-to-one-sessions.index')); ?>" @click="if(window.innerWidth<1024) sidebarOpen=false"
               class="ins-nav <?php echo e(request()->routeIs('instructor.one-to-one-sessions.*') ? 'active' : ''); ?>">
                <span class="ins-icon bg-violet-100 dark:bg-violet-900/40 text-violet-600 dark:text-violet-400">
                    <i class="fas fa-user-graduate text-sm"></i>
                </span>
            ...
            <?php endif; ?>
            <?php if(Route::has('instructor.tutor-work-schedule.index')): ?>
            <a href="<?php echo e(route('instructor.tutor-work-schedule.index')); ?>" @click="if(window.innerWidth<1024) sidebarOpen=false"
               class="ins-nav <?php echo e(request()->routeIs('instructor.tutor-work-schedule.*') ? 'active' : ''); ?>">
...
<?php /**PATH C:\xampp\htdocs\glottical\resources\views\layouts\instructor-sidebar.blade.php ENDPATH**/ ?>