...
<?php $__env->startSection('page_title', 'إضافة معاملة جديدة'); ?>
...
<div class="space-y-5">
    ...
    <form action="<?php echo e(route('admin.transactions.store')); ?>" method="POST" class="space-y-5">
        <?php echo csrf_field(); ?>
        ...
        <article class="overflow-hidden rounded-2xl border border-line bg-surface shadow-soft">
            ...
            <div class="grid grid-cols-1 gap-4 p-4 sm:grid-cols-2 sm:p-5">
                <div class="sm:col-span-2">
                    <label class="<?php echo e($labelClass); ?>" for="transaction-client-search">العميل <span class="text-danger">*</span></label>
                    ...
                    <select id="transaction-user-id" name="user_id" required class="<?php echo e($fieldClass); ?>">
                ...
                <div>
                    ...
                    <input id="amount" type="number" name="amount" step="0.01" min="0" required value="<?php echo e(old('amount')); ?>" class="<?php echo e($fieldClass); ?>">
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views/admin/transactions/create.blade.php ENDPATH**/ ?>