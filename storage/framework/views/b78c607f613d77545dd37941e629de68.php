<?php $__env->startSection('title', 'السنوات الأكاديمية'); ?>
<?php $__env->startSection('header', 'السنوات الأكاديمية'); ?>
            ...
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                <div class="space-y-4 max-w-3xl">
                    <span class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-sky-100 text-sky-700 text-sm font-semibold">
                        ...
                        إدارة السنوات الأكاديمية — <?php echo e(config('app.name')); ?>
                    ...
                    <div class="px-4 py-5 sm:px-6 border-b border-gray-100 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                        <div class="space-y-2 flex-1">
                            ...
                            <p class="text-sm text-gray-600 max-w-xl">
                                <?php echo e($track->description ? Str::limit($track->description, 160) : 'سنة أكاديمية تنظّم مجموعات مهارية وكورسات مرتبطة ضمن هيكل المحتوى الداخلي.'); ?>
                            ...
                            <div class="flex flex-wrap items-center gap-2">
                                ...
                                <form method="POST" action="<?php echo e(route('admin.academic-years.toggle-status', $track)); ?>" class="inline">
                                    ...
                                    <button type="submit" class="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-slate-100 text-slate-600 hover:bg-slate-200 text-xs font-semibold">
                                        ...
                                        <?php echo e($track->is_active ? 'إيقاف مؤقت' : 'تفعيل السنة'); ?>

                                    </button>
                                </form>
                                <form method="POST" action="<?php echo e(route('admin.academic-years.destroy', $track)); ?>" class="inline" onsubmit="return confirm('هل أنت متأكد من حذف هذه السنة الأكاديمية؟ سيتم حذف جميع البيانات المرتبطة بها. هذا الإجراء لا يمكن التراجع عنه!');">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\admin\academic-years\index.blade.php ENDPATH**/ ?>