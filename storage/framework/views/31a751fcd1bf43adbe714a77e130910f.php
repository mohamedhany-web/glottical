...
<div id="lk-room-shell" class="lk-room lk-theme-<?php echo e($lkTheme); ?> relative flex-1 min-h-0 flex flex-col" data-lk-theme="<?php echo e($lkTheme); ?>" data-lk-role="<?php echo e($lkRole); ?>">
            ...
            <div id="lk-focus" class="lk-focus hidden" aria-live="polite">
                ...
                <div class="lk-focus__bar">
                    ...
                    <div class="lk-focus__zoom">
                        ...
                        <input type="range" id="lk-zoom-slider" class="lk-zoom-slider" min="75" max="<?php echo e((int) round($lkZoomMax * 100)); ?>" step="5" value="100" aria-label="مستوى التكبير">
    ...
    <div class="lk-toolbar shrink-0">
        <div id="lk-toolbar-zoom" class="lk-toolbar-zoom hidden" aria-label="تحكم التكبير">
            ...
            <input type="range" id="lk-toolbar-zoom-slider" class="lk-zoom-slider lk-zoom-slider--toolbar" min="75" max="<?php echo e((int) round($lkZoomMax * 100)); ?>" step="5" value="100" aria-label="مستوى التكبير">
        ...
        <button type="button" id="lk-toggle-mic" class="lk-btn<?php echo e($lkStartAudio ? ' is-on-active' : ' is-off'); ?>" aria-pressed="<?php echo e($lkStartAudio ? 'true' : 'false'); ?>" title="<?php echo e($lkStartAudio ? 'إيقاف الميكروفون' : 'تشغيل الميكروفون'); ?>"><i class="fas fa-<?php echo e($lkStartAudio ? 'microphone' : 'microphone-slash'); ?>"></i><span><?php echo e($lkStartAudio ? 'ميكروفون' : 'ميكروفون مقفول'); ?></span></button>
        <button type="button" id="lk-toggle-cam" class="lk-btn<?php echo e($lkStartVideo ? ' is-on-active' : ' is-off'); ?>" aria-pressed="<?php echo e($lkStartVideo ? 'true' : 'false'); ?>" title="<?php echo e($lkStartVideo ? 'إيقاف الكاميرا' : 'تشغيل الكاميرا'); ?>"><i class="fas fa-<?php echo e($lkStartVideo ? 'video' : 'video-slash'); ?>"></i><span><?php echo e($lkStartVideo ? 'كاميرا' : 'كاميرا مقفولة'); ?></span></button>
...
(function () {
    ...
    const lkTheme = <?php echo json_encode($lkTheme, 15, 512) ?>;
    const lkDefaultScreenZoom = <?php echo json_encode($lkDefaultScreenZoom, 15, 512) ?>;
    const ZOOM_MAX = <?php echo json_encode($lkZoomMax, 15, 512) ?>;
