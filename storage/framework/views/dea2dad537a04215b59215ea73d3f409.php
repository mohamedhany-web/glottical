    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-lg overflow-hidden">
        ...
        <div class="p-5 sm:p-8 space-y-6">
            ...
            <div class="rounded-xl border border-gray-200 dark:border-gray-600 p-4 sm:p-5">
                ...
                <a href="<?php echo e(storage_asset($consultation->payment_proof)); ?>" target="_blank" rel="noopener" class="block">
                    <img src="<?php echo e(storage_asset($consultation->payment_proof)); ?>" alt="إيصال الدفع" class="max-h-96 w-auto max-w-full rounded-lg border border-gray-200 dark:border-gray-600 shadow-sm mx-auto">
                </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\student\consultations\show.blade.php ENDPATH**/ ?>