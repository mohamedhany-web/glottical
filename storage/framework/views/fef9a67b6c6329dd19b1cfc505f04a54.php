    ...
    <div class="rounded-2xl bg-white border border-slate-200 shadow-sm p-6 space-y-3">
        ...
        <dl class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
            ...
            <div class="sm:col-span-2">
                ...
                <dd>
                    <a href="<?php echo e(storage_asset($consultation->payment_proof)); ?>" target="_blank" rel="noopener" class="inline-block">
                        <img src="<?php echo e(storage_asset($consultation->payment_proof)); ?>" alt="إيصال" class="max-h-64 rounded-lg border border-slate-200 shadow-sm">
                    </a>
                </dd>
            </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\admin\consultations\show.blade.php ENDPATH**/ ?>