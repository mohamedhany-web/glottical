...
<head>
  ...
  <title><?php echo $__env->yieldContent('title'); ?> — <?php echo e($brand); ?></title>
...
<body class="gl-auth sana-home" <?php echo $__env->yieldContent('body_attrs'); ?>>
  <div class="gl-auth-shell">
    ...
    <div class="gl-auth-layer">
      <nav class="gl-auth-nav">
        <a href="<?php echo e(route('home')); ?>" class="gl-auth-logo"><?php echo e($brand); ?></a>
        <div class="gl-auth-nav__actions">
          <div class="gl-auth-lang" role="group" aria-label="<?php echo e($isRtl ? 'اللغة' : 'Language'); ?>">
            <a href="<?php echo e($langSwitch('ar')); ?>" class="<?php echo e($isRtl ? 'is-on' : ''); ?>" hreflang="ar">عربي</a>
            <a href="<?php echo e($langSwitch('en')); ?>" class="<?php echo e(! $isRtl ? 'is-on' : ''); ?>" hreflang="en">EN</a>
          </div>
          <?php if (! empty(trim($__env->yieldContent('nav_action')))): ?>
            <?php echo $__env->yieldContent('nav_action'); ?>
          <?php else: ?>
            <a href="<?php echo e(route('home')); ?>" class="gl-auth-nav-link"><?php echo e(__('auth.back_to_home')); ?></a>
          <?php endif; ?>
        </div>
      </nav>
      <main class="gl-auth-main <?php echo $__env->yieldContent('main_class'); ?>">
...
<?php /**PATH C:\xampp\htdocs\glottical\resources\views\layouts\auth-landing.blade.php ENDPATH**/ ?>