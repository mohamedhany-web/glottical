...
<?php $__env->startSection('header', 'CRM — Lead #'.$salesLead->id); ?>
...
<div class="space-y-6 max-w-5xl">
    ...
    <a href="<?php echo e(route('admin.crm.leads.index')); ?>" class="text-sm text-sky-600 font-semibold">← القائمة</a>
    ...
    <div class="rounded-2xl bg-white border p-6 space-y-4">
        ...
        <dl class="grid sm:grid-cols-2 gap-3 text-sm">
            ...
            <div><dt class="text-slate-500">سيلز</dt><dd class="font-bold"><?php echo e($salesLead->assignedTo?->name ?? '—'); ?></dd></div>
            ...
            <div><dt class="text-slate-500">المجموعة</dt><dd><?php echo e($salesLead->crmGroup?->name ?? '—'); ?></dd></div>
        </dl>
        ...
        <div class="space-y-2 text-sm">
            <?php $__currentLoopData = $salesLead->commissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex justify-between border-b pb-2">
                    ...
                    <span class="font-bold"><?php echo e(number_format($c->commission_amount_egp, 2)); ?> ج.م (<?php echo e($c->status); ?>)</span>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
