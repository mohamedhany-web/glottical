                    ...
                    <ul class="space-y-3">
                        ...
                        <li class="flex flex-wrap items-center justify-between gap-3 p-4 bg-slate-50 rounded-xl border border-slate-200">
                            ...
                            <div class="flex items-center gap-3 flex-shrink-0">
                                ...
                                <?php endif; ?>
                                <a href="<?php echo e(storage_asset($material->file_path)); ?>" target="_blank" class="inline-flex items-center gap-1 text-indigo-600 hover:text-indigo-800 font-medium text-sm">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\admin\lectures\show.blade.php ENDPATH**/ ?>