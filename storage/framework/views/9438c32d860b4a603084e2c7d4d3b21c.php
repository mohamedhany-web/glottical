...
<?php $__env->startSection('title', ($media->title ?? 'مقال') . ' - Glottical'); ?>
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-lg p-8 border border-gray-200 card-hover">
                ...
                <div class="mb-6">
                    <img src="<?php echo e(storage_asset($media->file_path)); ?>" alt="<?php echo e($media->title); ?>" class="w-full rounded-lg shadow-lg">
                </div>
                <?php elseif($media->type == 'video'): ?>
                <div class="mb-6">
                    <video controls class="w-full rounded-lg shadow-lg">
                        <source src="<?php echo e(storage_asset($media->file_path)); ?>" type="<?php echo e($media->mime_type); ?>">
                ...
                <div class="bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg p-12 text-center mb-6 card-hover">
                    ...
                    <a href="<?php echo e(storage_asset($media->file_path)); ?>" download class="btn-primary">
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\public\media\show.blade.php ENDPATH**/ ?>