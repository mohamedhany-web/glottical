    ...
    <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <img src="<?php echo e(storage_asset($package->thumbnail)); ?>" alt="<?php echo e($package->name); ?>" class="w-full h-64 object-cover rounded-lg border border-gray-300">
            </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\admin\packages\show.blade.php ENDPATH**/ ?>