...
<?php $__env->startSection('meta_description', 'فعاليات ' . config('app.name') . ' — ورش لغوية ومهنية، ندوات، وأيام توظيف.'); ?>
<?php $__env->startSection('meta_keywords', 'فعاليات, Glottical, ورش عمل, كول سنتر, ألمانيا'); ?>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\public\events.blade.php ENDPATH**/ ?>