                    ...
                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                        ...
                        <td class="px-4 py-3 text-center">
                            <div class="inline-flex flex-wrap items-center justify-center gap-2">
                                <?php if($meeting->isLive()): ?>
                                    <a href="<?php echo e(route('admin.classroom-recordings.observe', $meeting)); ?>"
                                ...
                                <?php if($meeting->recording_download_url): ?>
                                    <a href="<?php echo e($meeting->recording_download_url); ?>" target="_blank" rel="noopener" class="px-3 py-1.5 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold">
                                        <i class="fas fa-download ml-1"></i> تحميل الفيديو
                                    </a>
                                <?php elseif($meeting->recording_audio_download_url): ?>
                                    <a href="<?php echo e($meeting->recording_audio_download_url); ?>" target="_blank" rel="noopener" class="px-3 py-1.5 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold">
                                ...
                                <?php else: ?>
                                    ...
                                    <?php endif; ?>
                                <?php endif; ?>
                                <?php if($meeting->hasBrowserRecording() || $meeting->recording_path || $meeting->recording_audio_path): ?>
                                    <form method="POST" action="<?php echo e(route('admin.classroom-recordings.destroy', $meeting)); ?>" class="inline"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/cityphone/Documents/glottical/resources/views/admin/classroom-recordings/index.blade.php ENDPATH**/ ?>