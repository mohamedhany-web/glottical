...
<?php $__env->startSection('title', 'إعداد تكامل الرسائل الخارجية - Glottical'); ?>
        ...
        <div class="flex items-center justify-between mb-2">
            <div>
                ...
                <p class="text-gray-600">
                    <?php echo e(__('من هنا يمكنك ربط Glottical بأي API خارجي لإرسال الرسائل (واتساب أو غيره) بطريقة آمنة ومرنة.')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\admin\messages\settings.blade.php ENDPATH**/ ?>