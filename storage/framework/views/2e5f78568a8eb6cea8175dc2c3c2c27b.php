                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <?php if($payment->status === 'paid' && $payment->transfer_receipt_path): ?>
                                <a href="<?php echo e(storage_asset($payment->transfer_receipt_path)); ?>" target="_blank" class="inline-flex items-center gap-1 text-sm text-blue-600 hover:text-blue-800 font-medium"><i class="fas fa-receipt"></i> تحميل الإيصال</a>
                            <?php else: ?>
...
<?php echo $__env->make('layouts.employee', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\employee\accounting\index.blade.php ENDPATH**/ ?>