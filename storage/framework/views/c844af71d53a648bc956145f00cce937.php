...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="space-y-2 md:col-span-2 rounded-xl border border-sky-100 dark:border-sky-900/40 bg-sky-50/70 dark:bg-sky-950/20 p-4">
                                    ...
                                    <select name="delivery_type" required class="w-full rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 px-4 py-3 text-slate-800 dark:text-slate-200">
                                        <option value="group" <?php if(old('delivery_type', 'group') === 'group'): echo 'selected'; endif; ?>>جماعي — مجموعة منظّمة مع مدرّس</option>
                                        <option value="one_to_one" <?php if(old('delivery_type') === 'one_to_one'): echo 'selected'; endif; ?>>فردي 1:1 — جلسات خاصة مع المدرّس</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="space-y-2 md:col-span-2">
                                    ...
                                    <select name="billing_mode" class="w-full rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 px-4 py-3 text-slate-800 dark:text-slate-200">
                                        <option value="one_time" <?php if(old('billing_mode', 'one_time') === 'one_time'): echo 'selected'; endif; ?>>دفعة واحدة</option>
                                        <option value="monthly" <?php if(old('billing_mode') === 'monthly'): echo 'selected'; endif; ?>>اشتراك شهري</option>
                                    </select>
                                </div>
                                <div class="space-y-2">
                                    <label class="block text-sm font-semibold text-slate-700 dark:text-slate-300">سعر الاشتراك الشهري (جنيه)</label>
                                    <input type="number" name="monthly_price" value="<?php echo e(old('monthly_price')); ?>" min="0" step="0.01"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="number" name="monthly_price_after_discount" value="<?php echo e(old('monthly_price_after_discount')); ?>" min="0" step="0.01"
                                           class="w-full rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 px-4 py-3 text-slate-800 dark:text-slate-200">
                                </div>
                            </div>
                        ...
                        <div class="p-6 sm:p-8 space-y-4 text-sm text-slate-700 dark:text-slate-300">
                            ...
                            <div class="space-y-2">
                                ...
                                <div>
                                    ...
                                    <input type="url" name="thumbnail_link" value="<?php echo e(old('thumbnail_link')); ?>" dir="ltr" placeholder="https://..."
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\admin\advanced-courses\create.blade.php ENDPATH**/ ?>