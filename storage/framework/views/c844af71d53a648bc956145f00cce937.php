...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="space-y-2 md:col-span-2">
                                    ...
                                    <select name="delivery_type" class="w-full rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 px-4 py-3 text-slate-800 dark:text-slate-200">
                                        <option value="group" <?php if(old('delivery_type', 'group') === 'group'): echo 'selected'; endif; ?>>جماعي</option>
                                        <option value="one_to_one" <?php if(old('delivery_type') === 'one_to_one'): echo 'selected'; endif; ?>>فردي 1:1 مع معلم</option>
                                    </select>
                                </div>
                                <div class="space-y-2 md:col-span-2">
