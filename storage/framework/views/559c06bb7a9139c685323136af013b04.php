...
<?php $__env->startSection('meta_description', 'سياسة الاسترداد والإلغاء لمنصة ' . config('app.name') . ' — تعرف على شروط استرداد مدفوعاتك.'); ?>
<?php $__env->startSection('meta_keywords', 'سياسة الاسترداد, استرداد المبلغ, Glottical, إلغاء الاشتراك'); ?>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\public\refund.blade.php ENDPATH**/ ?>