...
<body class="page-course-public antialiased font-body">
    ...
    <main class="flex-1">
        ...
        <?php $__currentLoopData = ['success' => 'emerald', 'info' => 'sky', 'error' => 'red']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(session($type)): ?>
            <div class="max-w-5xl mx-auto px-5 sm:px-8 pt-20 sm:pt-24 pb-2" x-data="{s:true}" x-show="s" <?php if($type!=='error'): ?> x-init="setTimeout(()=>s=false,6000)" <?php endif; ?>>
                <div class="rounded-2xl border border-<?php echo e($color); ?>-200/80 bg-white/95 backdrop-blur-sm px-5 py-4 flex items-center gap-3 shadow-sm">
        ...
        <section class="relative -mt-14 sm:-mt-[60px] pt-16 sm:pt-20 pb-10 sm:pb-14 overflow-hidden text-white">
            <?php if($thumbUrl): ?>
                <div class="absolute inset-0 bg-cover bg-center scale-105" style="background-image:url('<?php echo e($thumbUrl); ?>')"></div>
            <?php else: ?>
            ...
            <div class="container-1200 relative z-10">
                <nav class="reveal text-sm text-white/60 mb-6 sm:mb-8 flex items-center gap-2 flex-wrap pt-2">
                    <a href="<?php echo e(url('/')); ?>" class="hover:text-acad-yellow transition-colors"><?php echo e(__('public.home')); ?></a>
                    <i class="fas fa-chevron-<?php echo e($isRtl?'left':'right'); ?> text-[8px] text-white/35"></i>
                    <a href="<?php echo e(route('public.courses')); ?>" class="hover:text-acad-yellow transition-colors"><?php echo e(__('public.courses')); ?></a>
                    <i class="fas fa-chevron-<?php echo e($isRtl?'left':'right'); ?> text-[8px] text-white/35"></i>
                    <span class="text-white font-semibold"><?php echo e(Str::limit($course->title ?? '', 48)); ?></span>
                </nav>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 items-start">
                    <div class="lg:col-span-3 reveal">
                        ...
                        <div class="flex flex-wrap gap-2 mb-8">
                            ...
                            <div class="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-white/10 border border-white/15 text-white text-sm font-semibold backdrop-blur-sm">
                                <i class="fas <?php echo e($badge['icon']); ?> text-acad-yellow"></i>
                        ...
                        <?php if($course->instructor): ?>
                            <div class="flex items-center gap-3 mb-8">
                                ...
                                <div>
                                    <p class="text-xs text-white/55 font-medium"><?php echo e(__('public.instructor_label')); ?></p>
                                    <?php if(\App\Models\InstructorProfile::where('user_id', $course->instructor->id)->where('status', 'approved')->exists()): ?>
                                        <a href="<?php echo e(route('public.instructors.show', $course->instructor)); ?>" class="text-white font-bold hover:text-acad-yellow transition-colors"><?php echo e($course->instructor->name); ?></a>
                                    <?php else: ?>
                        ...
                        <div class="flex flex-wrap gap-3">
                            <?php if(auth()->guard()->check()): ?>
                                <?php if($isEnrolled ?? false): ?>
                                    <a href="<?php echo e(route('my-courses.show', $course)); ?>" class="inline-flex items-center gap-2.5 bg-acad-yellow text-acad-blue px-7 py-3.5 rounded-xl font-black shadow-lg shadow-black/25 hover:brightness-105 transition text-base">
                                        <i class="fas fa-play-circle"></i> <?php echo e(__('public.start_learning_now')); ?>

                                    </a>
                                <?php elseif($checkoutPrice > 0 && !($course->is_free ?? false)): ?>
                                    <a href="<?php echo e(route('public.course.checkout', $course->id)); ?>" class="inline-flex items-center gap-2.5 bg-acad-yellow text-acad-blue px-7 py-3.5 rounded-xl font-black shadow-lg shadow-black/25 hover:brightness-105 transition text-base">
                            ...
                            <?php if(auth()->guard()->guest()): ?>
                                <?php if($checkoutPrice > 0 && !($course->is_free ?? false)): ?>
                                    <a href="<?php echo e(route('register', ['redirect' => route('public.course.checkout', $course->id)])); ?>" class="inline-flex items-center gap-2.5 bg-acad-yellow text-acad-blue px-7 py-3.5 rounded-xl font-black shadow-lg shadow-black/25 hover:brightness-105 transition text-base">
                                        <i class="fas fa-shopping-cart"></i> <?php echo e(__('public.buy_now')); ?>

                                    </a>
                                <?php else: ?>
                                    <a href="<?php echo e(route('register', ['redirect' => route('public.course.show', $course->id)])); ?>" class="inline-flex items-center gap-2.5 bg-emerald-500 hover:bg-emerald-600 text-white px-7 py-3.5 rounded-xl font-black shadow-lg transition text-base">
                                        <i class="fas fa-gift"></i> <?php echo e(__('public.register_free')); ?>

                                    </a>
                                <?php endif; ?>
                            <?php endif; ?>
                            <a href="<?php echo e(route('public.courses')); ?>" class="inline-flex items-center gap-2 border-2 border-white/25 text-white hover:bg-white/10 px-6 py-3.5 rounded-xl font-bold text-base transition">
                    ...
                    <div class="lg:col-span-2 reveal stagger-2">
                        ...
                        <div class="rounded-2xl overflow-hidden border border-white/20 shadow-2xl shadow-black/40 bg-black ring-1 ring-white/10">
                            <div class="relative w-full aspect-video max-h-[min(70vh,520px)]">
                                <video src="<?php echo e($introDirectVideo); ?>" controls playsinline webkit-playsinline preload="metadata" poster="<?php echo e($thumbUrl); ?>" class="absolute inset-0 w-full h-full object-contain bg-black">
                ...
                <div class="reveal grid grid-cols-2 sm:grid-cols-4 gap-4 mb-14">
                    ...
                    <div class="card-hover rounded-2xl glass-panel-light p-5 sm:p-6 shadow-sm text-center hover:border-acad-cyan/25">
                        <div class="w-12 h-12 rounded-xl bg-acad-blueSoft flex items-center justify-center mx-auto mb-3">
                            <i class="fas <?php echo e($ic['icon']); ?> text-acad-blue text-xl"></i>
                        </div>
                        <p class="font-heading text-xl sm:text-2xl font-black text-acad-ink mb-1"><?php echo e($ic['value']); ?></p>
                    ...
                    <div class="lg:col-span-2 space-y-8">
                        ...
                        <div class="reveal card-hover rounded-2xl glass-panel-light p-6 sm:p-8 shadow-sm hover:border-acad-cyan/20">
                            <div class="flex items-center gap-3 mb-5">
                                ...
                                <h2 class="font-heading text-2xl font-black text-acad-ink"><?php echo e(__('public.about_course')); ?></h2>
                            </div>
                            <div class="text-slate-600 leading-relaxed text-base">
                                ...
                                <div class="mt-6">
                                    <h3 class="font-heading text-lg font-bold text-acad-ink mb-3"><?php echo e(__('public.course_objectives')); ?></h3>
                        ...
                        <div class="reveal stagger-1 card-hover rounded-2xl glass-panel-light p-6 sm:p-8 shadow-sm hover:border-emerald-200/60">
                            <div class="flex items-center gap-3 mb-5">
                                ...
                                <h2 class="font-heading text-2xl font-black text-acad-ink"><?php echo e(__('public.what_you_learn')); ?></h2>
                            </div>
                        ...
                        <div class="reveal stagger-2 card-hover rounded-2xl glass-panel-light p-6 sm:p-8 shadow-sm hover:border-amber-200/70">
                            <div class="flex items-center gap-3 mb-5">
                                ...
                                <h2 class="font-heading text-2xl font-black text-acad-ink"><?php echo e(__('public.requirements')); ?></h2>
                            </div>
                        ...
                        <div class="reveal sticky top-24 space-y-6">
                            <div class="card-hover rounded-2xl glass-panel-light shadow-lg overflow-hidden border border-acad-blue/10">
                                <div class="bg-gradient-to-l from-acad-blue via-acad-blue to-acad-blueDark p-5 text-center relative overflow-hidden">
                                    ...
                                    <?php if($checkoutPrice > 0 && !($course->is_free ?? false)): ?>
                                        <?php if($isMonthly): ?>
                                            <div class="text-3xl font-black text-white tabular-nums"><?php echo e(number_format($checkoutPrice, 0)); ?> <span class="text-lg font-medium text-white/80"><?php echo e(__('public.currency_egp')); ?> / <?php echo e(__('public.per_month')); ?></span></div>
                                            <?php if($course->isOneToOne() && $course->instructor): ?>
                                                <p class="text-xs text-white/70 mt-2"><?php echo e(__('public.one_to_one_with')); ?> <?php echo e($course->instructor->name); ?></p>
                                            <?php endif; ?>
                                        <?php elseif($course->hasPromotionalPrice()): ?>
                                            ...
                                            <div class="text-3xl font-black text-white tabular-nums"><?php echo e(number_format($checkoutPrice, 0)); ?> <span class="text-lg font-medium text-white/80"><?php echo e(__('public.currency_egp')); ?></span></div>
                                        <?php else: ?>
                                            <div class="text-3xl font-black text-white tabular-nums"><?php echo e(number_format($checkoutPrice, 0)); ?> <span class="text-lg font-medium text-white/80"><?php echo e(__('public.currency_egp')); ?></span></div>
                                        <?php endif; ?>
                                    <?php else: ?>
                                ...
                                <div class="p-6">
                                    <dl class="space-y-3 mb-6">
                                        <div class="flex justify-between items-center p-3 bg-acad-blueSoft/50 rounded-xl text-sm border border-acad-blue/5">
                                            <span class="text-slate-500 flex items-center gap-2"><i class="fas fa-clock text-acad-cyan"></i> <?php echo e(__('public.duration')); ?></span>
                                            <span class="font-bold text-acad-ink"><?php echo e($course->duration_hours ?? 0); ?> <?php echo e(__('public.hours')); ?></span>
                                        </div>
                                        <div class="flex justify-between items-center p-3 bg-acad-blueSoft/50 rounded-xl text-sm border border-acad-blue/5">
                                            <span class="text-slate-500 flex items-center gap-2"><i class="fas fa-chalkboard-teacher text-acad-blue"></i> <?php echo e(__('public.lectures_count_label')); ?></span>
                                            <span class="font-bold text-acad-ink"><?php echo e($course->lessons_count ?? 0); ?></span>
                                        </div>
                                        <div class="flex justify-between items-center p-3 bg-acad-blueSoft/50 rounded-xl text-sm border border-acad-blue/5">
                                            <span class="text-slate-500 flex items-center gap-2"><i class="fas fa-folder-open text-acad-cyan"></i> <?php echo e(__('public.course_category_label')); ?></span>
                                            <span class="font-bold text-acad-ink"><?php echo e($categoryDisplay); ?></span>
                                        </div>
                                    </dl>
                                    <?php if(auth()->guard()->check()): ?>
                                        <?php if($isEnrolled ?? false): ?>
                                            <a href="<?php echo e(route('my-courses.show', $course)); ?>" class="block w-full text-center py-3.5 rounded-xl bg-acad-yellow text-acad-blue font-black shadow-md hover:brightness-105 transition">
                                                <i class="fas fa-play-circle <?php echo e($isRtl?'ml-2':'mr-2'); ?>"></i><?php echo e(__('public.start_learning_now')); ?>

                                            </a>
                                        <?php elseif($checkoutPrice > 0 && !($course->is_free ?? false)): ?>
                                            <a href="<?php echo e(route('public.course.checkout', $course->id)); ?>" class="block w-full text-center py-3.5 rounded-xl bg-acad-yellow text-acad-blue font-black shadow-md hover:brightness-105 transition">
                                    ...
                                    <?php if(auth()->guard()->guest()): ?>
                                        <?php if($checkoutPrice > 0 && !($course->is_free ?? false)): ?>
                                            <a href="<?php echo e(route('register', ['redirect' => route('public.course.checkout', $course->id)])); ?>" class="block w-full text-center py-3.5 rounded-xl bg-acad-yellow text-acad-blue font-black shadow-md hover:brightness-105 transition">
                                                <i class="fas fa-shopping-cart <?php echo e($isRtl?'ml-2':'mr-2'); ?>"></i><?php echo e(__('public.buy_now')); ?>

                                            </a>
                                        <?php else: ?>
                                            <a href="<?php echo e(route('register', ['redirect' => route('public.course.show', $course->id)])); ?>" class="block w-full text-center py-3.5 rounded-xl bg-emerald-500 hover:bg-emerald-600 text-white font-black shadow-md transition">
                                                <i class="fas fa-gift <?php echo e($isRtl?'ml-2':'mr-2'); ?>"></i><?php echo e(__('public.register_free')); ?>
                            ...
                            <div class="rounded-2xl glass-panel-light p-6 shadow-sm border border-acad-blue/8">
                                ...
                                <div class="space-y-3">
                                    <?php $__currentLoopData = $relatedCourses->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <a href="<?php echo e(route('public.course.show', $related->id)); ?>" class="flex gap-3 p-3 rounded-xl border border-slate-200/80 hover:border-acad-yellow/45 hover:shadow-md transition-all duration-300 group bg-white/60">
                                            <div class="w-16 h-16 flex-shrink-0 rounded-xl bg-gradient-to-br from-acad-blue to-acad-navy overflow-hidden flex items-center justify-center">
                                                <?php if($relThumb): ?>
                                                    <img src="<?php echo e(storage_asset($relThumb)); ?>" alt="" class="w-full h-full object-cover group-hover:scale-105 transition-transform">
                                                <?php else: ?>
                                                    <i class="fas fa-book text-white/80 text-lg"></i>
                                                <?php endif; ?>
                                            </div>
                                            <div class="flex-1 min-w-0">
                                                <h4 class="font-bold text-acad-ink text-sm group-hover:text-acad-blue transition-colors line-clamp-2 leading-snug"><?php echo e($related->title); ?></h4>
        ...
        <section class="relative py-16 md:py-20 overflow-hidden">
            ...
            <div class="container-1200 text-center reveal relative z-10">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('my-courses.show', $course)); ?>" class="inline-flex items-center justify-center gap-3 bg-acad-yellow text-acad-blue font-black text-lg px-8 py-4 rounded-xl shadow-lg shadow-acad-blue/15 hover:brightness-105 transition">
                            <?php echo e(__('public.start_learning_now')); ?> <i class="fas fa-arrow-<?php echo e($isRtl?'left':'right'); ?> text-sm"></i>
                        </a>
                    <?php endif; ?>
                    <?php if(auth()->guard()->guest()): ?>
                        <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center justify-center gap-3 bg-acad-yellow text-acad-blue font-black text-lg px-8 py-4 rounded-xl shadow-lg shadow-acad-blue/15 hover:brightness-105 transition">
                            <?php echo e(__('public.register_free_now')); ?> <i class="fas fa-arrow-<?php echo e($isRtl?'left':'right'); ?> text-sm"></i>
                        </a>
                    <?php endif; ?>
                    <a href="<?php echo e(route('public.courses')); ?>" class="btn-outline inline-flex items-center justify-center gap-3 bg-white/90 border-2 border-acad-blue/15 hover:border-acad-cyan/40 text-acad-ink font-semibold text-lg px-8 py-4 rounded-xl backdrop-blur-sm">
