...
<?php
    ...
    $academySignatureTitle = $academySignatureTitle ?? ($certificate->academy_signature_title ?? (config('app.name').' Academy'));
...
<div id="certificate-template" class="certificate-template template-<?php echo e($template); ?> relative mx-auto certificate-print" style="width: 297mm; height: 210mm; padding: 25mm 20mm; margin: 0 auto; box-sizing: border-box;">
    <!-- Watermark -->
    <div class="certificate-watermark"><?php echo e(strtoupper(preg_replace('/\s+/', '', config('app.name')))); ?></div>
    ...
    <div class="relative z-20 h-full flex flex-col">
        ...
        <div class="text-center mb-8">
            ...
            <div class="mb-4">
                ...
                <h3 class="text-lg font-black text-gray-800 mb-0.5" style="color: inherit;"><?php echo e(config('app.name')); ?></h3>
            ...
            <div class="grid grid-cols-3 gap-6">
                ...
                <div class="text-center">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mb-2">
                            <img src="<?php echo e(storage_asset($certificate->instructor_signature)); ?>" alt="Instructor Signature" class="h-10 mx-auto object-contain">
                        </div>
                        <?php else: ?>
                ...
                <div class="text-center">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mb-2">
                            <img src="<?php echo e(storage_asset($certificate->academy_signature)); ?>" alt="Academy Signature" class="h-10 mx-auto object-contain">
                        </div>
                        <?php else: ?>
                        <div class="signature-line" style="width: 150px; margin: 8px auto;"></div>
                        <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\glottical\resources\views\components\certificate-templates.blade.php ENDPATH**/ ?>