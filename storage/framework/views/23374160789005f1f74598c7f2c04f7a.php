    ...
    <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
        <div class="flex justify-between items-center flex-wrap gap-3">
            <div>
                ...
                <a href="<?php echo e(route('admin.crm.sales-permissions.edit', $employee)); ?>" class="inline-flex items-center gap-2 mt-2 text-sm font-bold text-violet-700 hover:text-violet-900">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\admin\employees\edit.blade.php ENDPATH**/ ?>