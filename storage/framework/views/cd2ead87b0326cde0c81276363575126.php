...
<?php $__env->startSection('meta_description', 'تعرف على فريق ' . config('app.name') . ' — خبراء اللغة والتوجيه المهني لربط التعليم بفرص العمل.'); ?>
<?php $__env->startSection('meta_keywords', 'فريق العمل, Glottical, فريق المنصة, من نحن'); ?>
            ...
            <div class="bg-gradient-to-br from-white to-gray-50 rounded-xl shadow-lg overflow-hidden card-hover">
                ...
                <div class="p-6 text-center">
                    ...
                    <p class="text-gray-600 text-sm mb-4">
                        نعمل على تطوير تجربة المعلّم والمتعلّم على <?php echo e(config('app.name')); ?> باستمرار
                    </p>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\public\team.blade.php ENDPATH**/ ?>