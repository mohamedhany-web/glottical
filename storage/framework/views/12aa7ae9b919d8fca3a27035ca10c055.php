...
<?php $__env->startSection('title', 'التقارير الشهرية - Glottical'); ?>
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between mb-2">
            <div>
                ...
                <p class="text-gray-600"><?php echo e(__('متابعة التقارير الشهرية المرسلة للطلاب وأولياء الأمور عبر منصة Glottical')); ?></p>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\admin\messages\monthly-reports.blade.php ENDPATH**/ ?>