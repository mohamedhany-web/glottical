...
<head>
  ...
  <title><?php echo e(__('public.testimonials_page_title')); ?> — <?php echo e($brand); ?></title>
  <meta name="description" content="<?php echo e(__('public.home_testimonials_sub')); ?>">
  <meta name="theme-color" content="#0B3D91">
  <link rel="canonical" href="<?php echo e(route('public.testimonials')); ?>">
...
<main class="gl-tm">
  <section class="gl-tm-hero">
    <div class="sana-container sana-reveal">
      <span class="gl-tm-hero__eyebrow"><i class="fas fa-quote-right"></i> <?php echo e(__('public.testimonials_page_title')); ?></span>
      <h1><?php echo e(__('public.home_testimonials_heading')); ?> <span class="hl"><?php echo e($brand); ?></span></h1>
      <p><?php echo e(__('public.home_testimonials_sub')); ?></p>
      <div class="gl-tm-metrics">
        <article class="gl-tm-metric">
          <strong><?php echo e(number_format($count)); ?></strong>
          <span><?php echo e($isRtl ? 'رأي منشور' : 'Published voices'); ?></span>
        </article>
        <article class="gl-tm-metric">
          <strong><?php echo e(number_format($featuredCount)); ?></strong>
          <span><?php echo e($isRtl ? 'آراء مميزة' : 'Featured'); ?></span>
        </article>
        <article class="gl-tm-metric">
          <strong><i class="fas fa-star" style="font-size:1.1rem;color:#F5B800"></i></strong>
          <span><?php echo e($isRtl ? 'تجارب حقيقية' : 'Real experiences'); ?></span>
        </article>
      </div>
    </div>
  </section>
    ...
    <div class="sana-container">
      <?php if($testimonials->isEmpty()): ?>
        <div class="gl-tm-empty sana-reveal">
          ...
          <h3><?php echo e(__('public.testimonials_page_title')); ?></h3>
          <p><?php echo e(__('public.home_testimonials_empty')); ?></p>
          <a href="<?php echo e(route('home')); ?>" class="sana-btn sana-btn--purple"><?php echo e(__('public.home')); ?></a>
        </div>
      <?php else: ?>
        <div class="gl-tm-grid sana-reveal">
          <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            ?>
            <article class="gl-tm-card <?php echo e($featured ? 'gl-tm-card--featured' : ''); ?>">
              <?php if($t->isImageType() && $t->publicImageUrl()): ?>
                <div class="gl-tm-card__media">
                  <img src="<?php echo e($t->publicImageUrl()); ?>" alt="" loading="lazy" decoding="async">
                </div>
              <?php endif; ?>
              <div class="gl-tm-card__body">
                ...
                <?php if($bodyText !== ''): ?>
                  <p class="gl-tm-card__text">
                    <?php if($t->isImageType()): ?>
                      <?php echo e(\Illuminate\Support\Str::limit($bodyText, 160)); ?>

                    <?php else: ?>
                      «<?php echo e(\Illuminate\Support\Str::limit($bodyText, 260)); ?>»
                    <?php endif; ?>
                  </p>
                <?php endif; ?>
                <?php if($t->author_name || $t->role_label): ?>
                  <div class="gl-tm-card__author">
                    <span class="gl-tm-card__avatar"><?php echo e($initial); ?></span>
                    <div class="min-w-0">
                      <?php if($t->author_name): ?>
                        <strong><?php echo e($t->author_name); ?></strong>
                      <?php endif; ?>
                      <?php if($t->role_label): ?>
                        <span><?php echo e($t->role_label); ?></span>
                      <?php endif; ?>
                    </div>
                  </div>
                <?php endif; ?>
  ...
  <div class="sana-container">
    <section class="gl-tm-final sana-reveal">
      <h2><?php echo e($isRtl ? 'جاهز تبدأ رحلتك معنا؟' : 'Ready to start your journey?'); ?></h2>
      <p><?php echo e($isRtl ? 'احجز تقييم مستوى مجاني أو تواصل معنا عبر واتساب — نرشدك للمسار المناسب.' : 'Book a free level assessment or message us on WhatsApp — we’ll guide you to the right path.'); ?></p>
...
<?php /**PATH C:\xampp\htdocs\glottical\resources\views\public\testimonials.blade.php ENDPATH**/ ?>