...
<body class="bg-[#F8FAFC] font-body transition-colors duration-300 dark:bg-slate-900"
    ...
    <div class="content-wrapper min-h-screen flex flex-col"
        ...
        <header class="top-navbar sticky top-0 z-40 flex items-center px-5 lg:px-8 gap-4">
            ...
            <div class="flex items-center shrink-0" title="<?php echo e(config('app.name')); ?>">
                <img src="<?php echo e($adminPanelLogoUrl); ?>" alt="" width="36" height="36" class="h-8 w-8 sm:h-9 sm:w-9 rounded-xl object-contain bg-white border border-slate-200/80 dark:border-slate-600 dark:bg-slate-800 shadow-sm" onerror="this.onerror=null;this.src='<?php echo e(\App\Services\AdminPanelBranding::inlineFallbackDataUri()); ?>';">
            </div>
            <?php endif; ?>
