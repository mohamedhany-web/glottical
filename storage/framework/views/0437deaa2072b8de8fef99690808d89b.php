...
<div class="flex flex-col h-full">
    ...
    <nav class="sidebar-nav flex-1 px-3 py-4 overflow-y-auto min-h-0">
        <ul class="space-y-0.5">
            ...
            <?php $insightsActive = request()->routeIs('admin.academy-insights.*'); ?>
            <li>
                <a href="<?php echo e(route('admin.academy-insights.index')); ?>"
                   class="sidebar-link <?php echo e($insightsActive ? 'active' : ''); ?>"
                   style="<?php echo e($insightsActive ? '' : 'box-shadow: inset 0 0 0 1px rgba(255,255,255,0.08);'); ?>">
            ...
            <?php if($isFull || $u->hasPermission('manage.contact-messages') || $u->hasPermission('manage.users') || $u->hasPermission('manage.personal-branding')): ?>
            <?php
                try {
            ...
            <li x-data="{ open: <?php echo e($hiringOpen ? 'true' : 'false'); ?> }">
                <button type="button" @click="open = !open" class="sidebar-group-btn">
                    <span class="flex items-center gap-3">
                        <i class="fas fa-user-tie"></i>
                        <span>توظيف المعلمين</span>
                        <?php if($hiringBadge > 0): ?>
                            <span class="sidebar-badge bg-amber-500 text-white"><?php echo e($hiringBadge > 99 ? '99+' : $hiringBadge); ?></span>
                        <?php endif; ?>
                    </span>
                ...
                <ul x-show="open" x-cloak class="mt-1 mr-3 space-y-0.5 border-r border-white/10 pr-3">
                    <li>
                        <a href="<?php echo e(route('admin.hiring-form.edit')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.hiring-form.*') ? 'active' : ''); ?>">
                            <i class="fas fa-wpforms"></i><span>منشئ نموذج التقديم</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('admin.tutor-applications.hub')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.tutor-applications.hub') ? 'active' : ''); ?>">
                            <i class="fas fa-briefcase"></i><span>لوحة التوظيف</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('admin.tutor-applications.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.tutor-applications.index') || request()->routeIs('admin.tutor-applications.show') ? 'active' : ''); ?>">
                            <i class="fas fa-inbox"></i><span>مراجعة الطلبات</span>
                            <?php if($sidebarTutorAppsPending > 0): ?>
                                <span class="sidebar-badge bg-amber-500 text-white"><?php echo e($sidebarTutorAppsPending); ?></span>
                            <?php endif; ?>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('admin.tutor-applications.index', ['status' => 'approved'])); ?>" class="sidebar-sub-link <?php echo e(request('status') === 'approved' && request()->routeIs('admin.tutor-applications.index') ? 'active' : ''); ?>">
                            <i class="fas fa-user-check"></i><span>بانتظار التفعيل</span>
                            <?php if($sidebarTutorAwaiting > 0): ?>
                                <span class="sidebar-badge bg-sky-500 text-white"><?php echo e($sidebarTutorAwaiting); ?></span>
                            <?php endif; ?>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('admin.tutor-applications.activated')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.tutor-applications.activated') ? 'active' : ''); ?>">
                            <i class="fas fa-chalkboard-teacher"></i><span>المعلمون المفعّلون</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('public.tutor.apply')); ?>" target="_blank" class="sidebar-sub-link">
            ...
            <li x-data="{ open: <?php echo e($studentControlOpen ? 'true' : 'false'); ?> }">
                ...
                <ul x-show="open" x-cloak class="mt-1 mr-3 space-y-0.5 border-r border-white/10 pr-3">
                    ...
                    <?php if(($isFull || $u->hasPermission('manage.tutoring-groups') || $u->hasPermission('manage.courses') || $u->hasPermission('manage.packages')) && Route::has('admin.placement.index')): ?>
                    <li>
                        <a href="<?php echo e(route('admin.placement.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.placement.*') ? 'active' : ''); ?>">
                            <i class="fas fa-user-check"></i><span>التسكين</span>
                        </a>
                    </li>
                    <?php endif; ?>

                    <?php if(($isFull || $u->hasPermission('manage.packages') || $u->hasPermission('manage.tutoring-groups') || $u->hasPermission('manage.users')) && Route::has('admin.student-entitlements.index')): ?>
                    <li>
                        <a href="<?php echo e(route('admin.student-entitlements.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.student-entitlements.*') ? 'active' : ''); ?>">
                            <i class="fas fa-coins"></i><span>أرصدة الطلاب</span>
                        </a>
                    </li>
                    <?php endif; ?>

                    <?php if(($isFull || $u->hasPermission('manage.packages') || $u->hasPermission('manage.tutoring-groups') || $u->hasPermission('manage.users')) && Route::has('admin.tutoring-subscriptions.index')): ?>
                    <li>
                        <a href="<?php echo e(route('admin.tutoring-subscriptions.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.tutoring-subscriptions.*') ? 'active' : ''); ?>">
                            <i class="fas fa-id-card"></i><span>اشتراكات التدريس</span>
                        </a>
                    </li>
                    <?php endif; ?>

                    <?php if(($isFull || $u->hasPermission('manage.tutoring-groups') || $u->hasPermission('manage.courses')) && Route::has('admin.one-to-one-sessions.index')): ?>
                    <li>
                    ...
                    <?php if(($isFull || $u->hasPermission('manage.tutoring-groups') || $u->hasPermission('manage.courses') || $u->hasPermission('manage.live-sessions')) && Route::has('admin.student-lesson-cleanup.index')): ?>
                    <li>
                        <a href="<?php echo e(route('admin.student-lesson-cleanup.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.student-lesson-cleanup.*') ? 'active' : ''); ?>">
                            <i class="fas fa-broom"></i><span>تنظيف الحصص والتجارب</span>
                        </a>
                    </li>
                    <?php endif; ?>

                    <?php if(($isFull || $u->hasPermission('manage.tutoring-groups')) && Route::has('admin.tutoring-group-bookings.index')): ?>
                    <li>
                        <a href="<?php echo e(route('admin.tutoring-group-bookings.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.tutoring-group-bookings.*') ? 'active' : ''); ?>">
                            <i class="fas fa-calendar-check"></i><span>تسكين الفصول والحجوزات</span>
                        </a>
                    </li>
                    <?php endif; ?>

                    <?php if(($isFull || $u->hasPermission('manage.tutoring-groups')) && Route::has('admin.tutoring-groups.index')): ?>
                    <li>
                        <a href="<?php echo e(route('admin.tutoring-groups.index', 'collective')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.tutoring-groups.*') && request()->route('type') === 'collective' ? 'active' : ''); ?>">
                            <i class="fas fa-school"></i><span>فصول المدرسة</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('admin.tutoring-groups.index', 'individual')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.tutoring-groups.*') && request()->route('type') === 'individual' ? 'active' : ''); ?>">
                            <i class="fas fa-user"></i><span>المجموعات الفردية</span>
                        </a>
                    </li>
                    <?php endif; ?>

                    <?php if(($isFull || $u->hasPermission('manage.tutoring-groups')) && Route::has('admin.tutor-work-schedules.index')): ?>
                    <li>
                        <a href="<?php echo e(route('admin.tutor-work-schedules.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.tutor-work-schedules.*') ? 'active' : ''); ?>">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.online-enrollments.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.online-enrollments.*') ? 'active' : ''); ?>">
                            <i class="fas fa-laptop"></i><span><?php echo e(__('admin.online_enrollments')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>

                    <?php if(($isFull || $u->hasPermission('manage.attendance')) && Route::has('admin.attendance.index')): ?>
                    <li>
                        <a href="<?php echo e(route('admin.attendance.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.attendance.*') ? 'active' : ''); ?>">
                            <i class="fas fa-user-check"></i><span>الحضور والانصراف</span>
                        </a>
                    </li>
                    <?php endif; ?>

                    <?php if($isFull && Route::has('admin.private-courses.threads')): ?>
                    <li>
                        <a href="<?php echo e(route('admin.private-courses.threads')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.private-courses.threads*') ? 'active' : ''); ?>">
                            <i class="fas fa-comments"></i><span>رسائل بريفيت</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('admin.private-courses.receptions')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.private-courses.receptions*') ? 'active' : ''); ?>">
            ...
            <?php if($isFull || $u->hasPermission('manage.users') || $u->hasPermission('manage.notifications') || $u->hasPermission('view.activity-log') || $u->hasPermission('view.statistics') || $u->hasPermission('manage.email-broadcasts') || $u->hasPermission('manage.performance') || $u->hasPermission('manage.two-factor-logs') || $u->hasPermission('manage.system-settings')): ?>
            ...
            <li x-data="{ open: <?php echo e($systemManagementOpen ? 'true' : 'false'); ?> }">
                ...
                <ul x-show="open" x-cloak class="mt-1 mr-3 space-y-0.5 border-r border-white/10 pr-3">
                    ...
                    <?php endif; ?>
                    <?php if($isFull || $u->hasPermission('manage.system-settings')): ?>
                    <li><a href="<?php echo e(route('admin.payment-gateways.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.payment-gateways.*') ? 'active' : ''); ?>"><i class="fas fa-credit-card"></i><span>بوابات الدفع</span></a></li>
                    <?php endif; ?>
            ...
            <?php if($isFull || $u->hasPermission('manage.coupons') || $u->hasPermission('manage.referrals') || $u->hasPermission('manage.popup-ads') || $u->hasPermission('manage.personal-branding')): ?>
            ...
            <?php if($isFull || $u->hasPermission('manage.packages') || $u->hasPermission('manage.tutoring-groups')): ?>
            ...
            ?>
            <li x-data="{ open: <?php echo e($paidPackagesOpen ? 'true' : 'false'); ?> }">
                <button type="button" @click="open = !open" class="sidebar-group-btn">
                ...
                <ul x-show="open" x-cloak class="mt-1 mr-3 space-y-0.5 border-r border-white/10 pr-3">
                    ...
                    <?php endif; ?>
                    <li><a href="<?php echo e(route('admin.service-packages.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.service-packages.index') || request()->routeIs('admin.service-packages.create') || request()->routeIs('admin.service-packages.edit') ? 'active' : ''); ?>"><i class="fas fa-box-open"></i><span>باقات الحصص</span></a></li>
                    <li><a href="<?php echo e(route('admin.service-packages.grant')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.service-packages.grant*') ? 'active' : ''); ?>"><i class="fas fa-user-plus"></i><span>منح باقة يدوياً</span></a></li>
                    <li><a href="<?php echo e(route('admin.service-package-pricing-rules.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.service-package-pricing-rules.*') ? 'active' : ''); ?>"><i class="fas fa-sliders"></i><span>تسعير خصص باقتك</span></a></li>
                </ul>
            </li>
            ...
            <?php if($isFull || $u->hasPermission('manage.lectures') || $u->hasPermission('manage.courses') || $u->hasPermission('manage.live-sessions') || $u->hasPermission('manage.academic-years') || $u->hasPermission('manage.academic-subjects')): ?>
            <?php
                $librariesOpen = request()->routeIs('admin.libraries.*') || request()->routeIs('admin.curriculum-library.*');
            ?>
            <li x-data="{ open: <?php echo e($librariesOpen ? 'true' : 'false'); ?> }">
                <button type="button" @click="open = !open" class="sidebar-group-btn">
                    <span class="flex items-center gap-3"><i class="fas fa-layer-group"></i><span>مكتبة الملفات</span></span>
                    <i class="fas fa-chevron-down chevron" :class="open ? 'rotate-180' : ''"></i>
                </button>
                <ul x-show="open" x-cloak class="mt-1 mr-3 space-y-0.5 border-r border-white/10 pr-3">
                    <?php if(Route::has('admin.libraries.index')): ?>
                    <li><a href="<?php echo e(route('admin.libraries.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.libraries.index') ? 'active' : ''); ?>"><i class="fas fa-th-large"></i><span>مركز الملفات</span></a></li>
                    <?php endif; ?>
                    <?php if(($isFull || $u->hasPermission('manage.lectures') || $u->hasPermission('manage.courses')) && Route::has('admin.libraries.materials.index')): ?>
                    <li><a href="<?php echo e(route('admin.libraries.materials.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.libraries.materials.*') ? 'active' : ''); ?>"><i class="fas fa-book-open"></i><span>ماتريال (ملفات)</span></a></li>
                    <?php endif; ?>
                    <?php if(($isFull || $u->hasPermission('manage.curriculum-library') || $u->hasPermission('manage.courses') || $u->hasPermission('manage.lectures')) && Route::has('admin.curriculum-library.index')): ?>
                    <li><a href="<?php echo e(route('admin.curriculum-library.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.curriculum-library.*') ? 'active' : ''); ?>"><i class="fas fa-chalkboard"></i><span>مناهج تفاعلية (ملفات)</span></a></li>
                    <?php endif; ?>
                    <?php if(($isFull || $u->hasPermission('manage.live-sessions') || $u->hasPermission('manage.lectures') || $u->hasPermission('manage.courses')) && Route::has('admin.libraries.videos.index')): ?>
                    <li><a href="<?php echo e(route('admin.libraries.videos.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.libraries.videos.*') ? 'active' : ''); ?>"><i class="fas fa-film"></i><span>مكتبة الفيديوهات</span></a></li>
                    <?php endif; ?>
                    <?php if(($isFull || $u->hasPermission('manage.academic-years') || $u->hasPermission('manage.academic-subjects') || $u->hasPermission('manage.courses')) && Route::has('admin.libraries.curriculum.index')): ?>
                    <li><a href="<?php echo e(route('admin.libraries.curriculum.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.libraries.curriculum.*') ? 'active' : ''); ?>"><i class="fas fa-sitemap"></i><span>هيكل الكورسات</span></a></li>
                    <?php endif; ?>
                </ul>
            </li>
            <?php endif; ?>
            <?php if($isFull || $u->hasPermission('manage.users') || $u->hasPermission('manage.tutoring-groups') || $u->hasPermission('manage.courses')): ?>
            <?php $teacherControlOpen = request()->routeIs('admin.teachers.*'); ?>
            <li x-data="{ open: <?php echo e($teacherControlOpen ? 'true' : 'false'); ?> }">
                <button type="button" @click="open = !open" class="sidebar-group-btn">
                ...
                <ul x-show="open" x-cloak class="mt-1 mr-3 space-y-0.5 border-r border-white/10 pr-3">
                    <li>
                        <a href="<?php echo e(route('admin.teachers.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.teachers.index') ? 'active' : ''); ?>">
                            <i class="fas fa-th-large"></i><span>مركز التحكم</span>
                        </a>
                    </li>
                    <?php if(Route::has('admin.academy-instructors.index') && ($isFull || $u->hasPermission('manage.academic-years') || $u->hasPermission('manage.tutoring-groups') || $u->hasPermission('manage.users'))): ?>
                    <li>
                        <a href="<?php echo e(route('admin.academy-instructors.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.academy-instructors.*') ? 'active' : ''); ?>">
                            <i class="fas fa-user-check"></i><span>توصيف الطلاب</span>
                        </a>
                    </li>
                    <?php endif; ?>
                    <?php if(Route::has('admin.tutor-work-schedules.index') && ($isFull || $u->hasPermission('manage.tutoring-groups'))): ?>
                    <li>
                        <a href="<?php echo e(route('admin.tutor-work-schedules.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.tutor-work-schedules.*') ? 'active' : ''); ?>">
            ...
            <li x-data="{ open: <?php echo e($contentManagementOpen ? 'true' : 'false'); ?> }">
                ...
                <ul x-show="open" x-cloak class="mt-1 mr-3 space-y-0.5 border-r border-white/10 pr-3">
                    ...
                    <li><a href="<?php echo e(route('admin.academic-years.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.academic-years.*') ? 'active' : ''); ?>"><i class="fas fa-school"></i><span>سنوات المدرسة</span></a></li>
                    <?php endif; ?>
                    <?php if($isFull || $u->hasPermission('manage.academic-subjects') || $u->hasPermission('manage.academic-years')): ?>
                    <li><a href="<?php echo e(route('admin.academic-subjects.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.academic-subjects.*') ? 'active' : ''); ?>"><i class="fas fa-book"></i><span>مواد المدرسة</span></a></li>
                    <?php endif; ?>
                ...
                <ul x-show="open" x-cloak class="mt-1 mr-3 space-y-0.5 border-r border-white/10 pr-3">
                    <li>
                        <a href="<?php echo e(route('admin.certificates.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.certificates.index') ? 'active' : ''); ?>">
                            ...
                            <?php try { $totalCertificates = \App\Models\Certificate::count(); } catch (\Throwable $e) { $totalCertificates = 0; } ?>
...
<?php /**PATH /Users/cityphone/Documents/glottical/resources/views/layouts/admin-sidebar.blade.php ENDPATH**/ ?>