...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(route('assets.student-timeline.css')); ?>?v=st-live-1">
    <style>
        :root {
            --st-bg: #f8f9fa;
            --st-ink: #4f4f4f;
...
<body>
    <div id="mx-session-ended">
        ...
        <a href="<?php echo e(route('student.live-sessions.index')); ?>" class="st-live-pill st-live-pill--gold">
    ...
    <div class="st-live-shell">
        <header class="st-live-top">
            <div class="flex items-center gap-3 min-w-0">
                <a href="<?php echo e(route('student.live-sessions.index')); ?>" class="st-live-brand">
                ...
                <div class="st-live-meta">
                    ...
                    <h1 class="st-live-meta__title"><?php echo e($liveSession->title); ?></h1>
                    <?php if($liveSession->instructor): ?>
                        <p class="st-live-meta__sub hidden sm:block"><?php echo e($liveSession->instructor->name); ?></p>
                    <?php endif; ?>
                </div>
            </div>
            <div class="st-live-actions">
                ...
                <form method="POST" action="<?php echo e(route('student.live-sessions.leave', $liveSession)); ?>" class="inline m-0" id="student-live-leave-form">
                    <?php echo csrf_field(); ?>
            ...
            <div id="mx-video-stack" class="st-live-stage">
                ...
                <?php else: ?>
                    <div class="flex-1 flex flex-col items-center justify-center gap-3 p-8 text-center text-slate-200">
                        ...
                        <a href="<?php echo e(route('student.live-sessions.index')); ?>" class="st-live-pill st-live-pill--gold mt-2">العودة للجلسات</a>
                    </div>
                <?php endif; ?>
    ...
    <script>
        (function () {
            var indexUrl = <?php echo json_encode(route('student.live-sessions.index'), 15, 512) ?>;
            var statusUrl = <?php echo json_encode(route('student.live-sessions.status', $liveSession), 512) ?>;
...
<?php /**PATH /Users/cityphone/Documents/glottical/resources/views/student/live-sessions/room.blade.php ENDPATH**/ ?>