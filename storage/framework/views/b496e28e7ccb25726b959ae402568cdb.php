<div class="flex flex-col h-full bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-900">
    ...
    <div class="p-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-sky-50 to-slate-50 dark:from-gray-800 dark:to-gray-900">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-lg font-black text-gray-900 dark:text-white"><?php echo e(config('app.name')); ?></h2>
                <p class="text-xs text-sky-600 dark:text-sky-400 font-medium"><?php echo e(config('app.name')); ?></p>
            </div>
        </div>
    </div>
    ...
    <nav class="flex-1 p-4 overflow-y-auto sidebar">
        <ul class="space-y-2">
            ...
            <?php if (\Illuminate\Support\Facades\Blade::check('hasAnyPermission', 'manage.invoices', 'manage.payments', 'manage.transactions', 'manage.wallets', 'manage.installments', 'manage.expenses')): ?>
                <!-- إدارة المحاسبة -->
                <?php
...
</div><?php /**PATH C:\xampp\htdocs\glottical\resources\views\layouts\sidebar.blade.php ENDPATH**/ ?>