...
<?php $__env->startSection('title', __('instructor.agreement_details_title') . ' - ' . config('app.name')); ?>
                                ...
                                <tr class="hover:bg-slate-50 dark:bg-slate-800/40 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <?php if($payment->status == 'paid' && $payment->transfer_receipt_path): ?>
                                            <a href="<?php echo e(storage_asset($payment->transfer_receipt_path)); ?>" target="_blank" class="inline-flex items-center gap-1 px-2.5 py-1 bg-slate-100 dark:bg-slate-700/50 hover:bg-slate-200 text-slate-700 dark:text-slate-300 rounded-lg text-xs font-semibold">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\instructor\agreements\show.blade.php ENDPATH**/ ?>