...
<?php $__env->startSection('meta_description', 'المكتبة الإعلامية لـ ' . config('app.name') . ' — مقالات وفيديوهات عن تعليم اللغة والمهارات المهنية.'); ?>
<?php $__env->startSection('meta_keywords', 'مكتبة إعلامية, Glottical, تعليم ألماني, كول سنتر'); ?>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <a href="<?php echo e(route('public.media.show', $item)); ?>" class="block bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all border border-gray-200 card-hover">
                ...
                <img src="<?php echo e(storage_asset($item->file_path)); ?>" alt="<?php echo e($item->title); ?>" class="w-full h-48 object-cover" loading="lazy" decoding="async">
                <?php elseif($item->type == 'video'): ?>
                <div class="w-full h-48 bg-gray-200 flex items-center justify-center relative">
                    <?php if($item->thumbnail_path): ?>
                    <img src="<?php echo e(storage_asset($item->thumbnail_path)); ?>" alt="<?php echo e($item->title); ?>" class="w-full h-full object-cover" loading="lazy" decoding="async">
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\public\media\index.blade.php ENDPATH**/ ?>