...
<head>
  ...
  <link rel="canonical" href="<?php echo e(route('public.services.index')); ?>">
...
<main class="gl-svci">
  <section class="gl-svci-hero">
    <div class="sana-container sana-reveal">
      <span class="gl-svci-hero__eyebrow"><i class="fas fa-concierge-bell"></i> <?php echo e(__('public.services_page_title')); ?></span>
      <h1><?php echo e(__('public.services_heading')); ?> <span class="hl"><?php echo e($brand); ?></span></h1>
      <p><?php echo e(__('public.services_subtitle')); ?></p>
      <div class="gl-svci-metrics">
        <article class="gl-svci-metric">
          <strong><?php echo e(number_format($services->count())); ?></strong>
          <span><?php echo e(__('public.services_count_label')); ?></span>
        </article>
        <article class="gl-svci-metric">
          <strong><i class="fas fa-check-circle" style="font-size:1.15rem"></i></strong>
          <span><?php echo e(__('public.services_quality_hint')); ?></span>
        </article>
        <article class="gl-svci-metric">
          <strong><i class="fas fa-headset" style="font-size:1.15rem"></i></strong>
          <span><?php echo e(__('public.services_support_hint')); ?></span>
        </article>
      </div>
    </div>
  </section>
    ...
    <div class="sana-container">
      <?php if($services->count() > 0): ?>
        <div class="gl-svci-grid sana-reveal">
          <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('public.services.show', $service)); ?>" class="gl-svci-card">
              <div class="gl-svci-card__media">
                <?php if($service->publicImageUrl()): ?>
                  <img src="<?php echo e($service->publicImageUrl()); ?>" alt="" loading="lazy" decoding="async">
                <?php else: ?>
              ...
              <div class="gl-svci-card__body">
                ...
                <p><?php echo e(\Illuminate\Support\Str::limit(strip_tags($service->summary ?: $service->body), 140)); ?></p>
      ...
      <?php else: ?>
        <div class="gl-svci-empty sana-reveal">
          ...
          <h3><?php echo e(__('public.services_empty_title')); ?></h3>
          <p><?php echo e(__('public.services_empty_desc')); ?></p>
