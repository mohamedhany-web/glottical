            ...
            <div class="container-acad relative z-10">
                <div class="max-w-4xl mx-auto text-center reveal">
                    <span class="inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-xs sm:text-sm font-extrabold mb-6 glass-panel text-white border border-white/10">
                        <i class="fas fa-concierge-bell text-[12px] opacity-80"></i> <?php echo e(__('public.services_page_title')); ?>

                    </span>
                    <h1 class="text-[2rem] sm:text-[2.8rem] lg:text-[3.35rem] leading-[1.18] font-black text-white mb-5 font-display">
                        <?php echo e(__('public.services_heading')); ?>

                    </h1>
                    <p class="text-white/70 text-base sm:text-lg leading-8 mb-7 max-w-3xl mx-auto"><?php echo e(__('public.services_subtitle')); ?></p>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mt-8 max-w-4xl mx-auto reveal s2">
                    <article class="rounded-2xl p-4 sm:p-5 border border-white/10 glass-panel text-center">
                        <p class="text-3xl sm:text-4xl font-black text-white"><?php echo e($services->count()); ?></p>
                        <p class="text-xs sm:text-sm text-white/55 mt-1"><?php echo e(__('public.services_count_label')); ?></p>
                    </article>
                    <article class="rounded-2xl p-4 sm:p-5 border border-white/10 glass-panel text-center">
                        <p class="text-3xl sm:text-4xl font-black text-acad-yellow"><i class="fas fa-check-circle"></i></p>
                        <p class="text-xs sm:text-sm text-white/55 mt-1"><?php echo e(__('public.services_quality_hint')); ?></p>
                    </article>
                    <article class="rounded-2xl p-4 sm:p-5 border border-white/10 glass-panel text-center">
                        <p class="text-3xl sm:text-4xl font-black text-acad-cyan"><i class="fas fa-headset"></i></p>
                        <p class="text-xs sm:text-sm text-white/55 mt-1"><?php echo e(__('public.services_support_hint')); ?></p>
                    </article>
                </div>
            </div>
        </section>
                ...
                <?php if($services->count() > 0): ?>
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
                        <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('public.services.show', $service)); ?>" class="card-stream reveal block group overflow-hidden s<?php echo e(($idx % 4) + 1); ?>">
                                ...
                                <div class="p-5">
                                    <h2 class="text-lg font-extrabold text-white leading-snug mb-2 line-clamp-2 group-hover:text-acad-yellow transition-colors"><?php echo e($service->name); ?></h2>
                                    <p class="text-sm text-white/55 leading-7 line-clamp-2 mb-4">
                                        <?php echo e(\Illuminate\Support\Str::limit(strip_tags($service->summary ?: $service->body), 120)); ?>

                                    </p>
                                    <div class="flex items-center justify-end pt-4 border-t border-white/10">
                                        <span class="text-acad-cyan text-xs font-bold arrow-link"><?php echo e(__('public.services_read_more')); ?></span>
                                    </div>
                                </div>
                            </a>
                ...
                <?php else: ?>
                    <div class="text-center py-20 reveal">
                        <div class="max-w-md mx-auto glass-panel rounded-3xl border border-white/10 p-10">
                            ...
                            <h3 class="text-2xl font-black text-white mb-3 font-display"><?php echo e(__('public.services_empty_title')); ?></h3>
                            <p class="text-white/65 leading-8 mb-6"><?php echo e(__('public.services_empty_desc')); ?></p>
                            <a href="<?php echo e(route('home')); ?>" class="btn-stream-primary inline-flex items-center gap-2"><?php echo e(__('public.home')); ?> <i class="fas fa-arrow-<?php echo e($isRtl ? 'left' : 'right'); ?> text-xs"></i></a>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="container-acad">
                <div class="reveal rounded-[28px] border border-white/10 glass-panel px-6 sm:px-10 py-10 sm:py-12 text-center overflow-hidden relative">
                    ...
                    <span class="relative z-10 inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-xs sm:text-sm font-extrabold mb-5 glass-panel border border-white/10">
                        <i class="fas fa-question-circle"></i> <?php echo e(__('public.services_cta_badge')); ?>

                    </span>
                    <h2 class="relative z-10 text-2xl sm:text-4xl font-black text-white mb-4 font-display"><?php echo e(__('public.services_cta_title')); ?></h2>
                    <p class="relative z-10 text-white/70 text-base sm:text-lg max-w-2xl mx-auto leading-8 mb-7"><?php echo e(__('public.services_cta_text')); ?></p>
                    <div class="relative z-10 flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
                        <a href="<?php echo e(route('public.contact')); ?>" class="btn-stream-primary"><?php echo e(__('public.contact_us')); ?> <i class="fas fa-arrow-<?php echo e($isRtl ? 'left' : 'right'); ?> text-xs"></i></a>
                        <a href="<?php echo e(route('public.courses')); ?>" class="btn-stream-secondary"><?php echo e(__('public.browse_courses')); ?></a>
                    </div>
                </div>
            </div>
        </section>
...
<?php /**PATH C:\xampp\htdocs\glottical\resources\views\public\services\index.blade.php ENDPATH**/ ?>