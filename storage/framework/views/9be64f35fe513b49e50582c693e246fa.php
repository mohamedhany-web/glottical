<?php $__env->startSection('title', 'الطلبات - التقارير المحاسبية - Glottical'); ?>
...
<div class="space-y-5">
    <section class="flex flex-wrap items-end justify-between gap-4">
        ...
        <div class="admin-hero-actions flex flex-wrap gap-2">
            <a href="<?php echo e(route('admin.accounting.reports.export', array_merge(request()->query(), ['type' => 'orders']))); ?>"
    ...
    <article class="overflow-hidden rounded-2xl border border-line bg-surface shadow-soft">
        ...
        <form method="GET" action="<?php echo e(route('admin.accounting.reports.orders')); ?>" class="grid grid-cols-1 gap-4 p-4 sm:p-5 md:grid-cols-2 xl:grid-cols-4 xl:items-end">
            <div>
    ...
    <article class="overflow-hidden rounded-2xl border border-line bg-surface shadow-soft">
        <div class="flex flex-wrap items-center justify-between gap-3 border-b border-line px-4 py-4 sm:px-5">
            ...
            <span class="inline-flex rounded-lg bg-accent-soft px-2.5 py-1 text-xs font-medium text-accent"><?php echo e(number_format($items->total())); ?> طلب</span>
        </div>
            ...
            <table class="min-w-full text-sm">
                ...
                <tbody class="divide-y divide-line">
                    <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $o): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php $badge = $statusBadges[$o->status] ?? ['label' => $o->status, 'classes' => 'bg-canvas-muted text-muted']; ?>
                        <tr class="hover:bg-canvas/40">
                            <td class="px-4 py-3">
                                <a href="<?php echo e(route('admin.orders.show', $o)); ?>" class="font-semibold text-accent hover:text-accent">#<?php echo e($o->id); ?></a>
                            </td>
                            <td class="px-4 py-3 text-ink-soft"><?php echo e($o->user->name ?? '—'); ?></td>
                            <td class="px-4 py-3 text-ink-soft"><?php echo e($o->course ? $o->course->title : ($o->learningPath ? $o->learningPath->name : '—')); ?></td>
                            <td class="px-4 py-3 font-semibold tabular-nums text-ink">
                                <?php echo e(number_format($o->amount, 2)); ?>
                            ...
                            <td class="px-4 py-3 text-xs tabular-nums text-muted"><?php echo e($o->created_at->format('Y-m-d H:i')); ?></td>
                        </tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views/admin/accounting/reports-orders.blade.php ENDPATH**/ ?>