...
<div class="flex flex-col h-full">
    ...
    <nav class="sidebar-nav flex-1 px-3 py-4 overflow-y-auto min-h-0">
        <ul class="space-y-0.5">
            ...
            <?php
                $paidPackagesOpen = request()->routeIs('admin.packages.*');
            ?>
            ...
            <li x-data="{ open: <?php echo e($contentManagementOpen ? 'true' : 'false'); ?> }">
                ...
                <ul x-show="open" x-cloak class="mt-1 mr-3 space-y-0.5 border-r border-white/10 pr-3">
                    ...
                    <li><a href="<?php echo e(route('admin.academic-years.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.academic-years.*') ? 'active' : ''); ?>"><i class="fas fa-calendar-alt"></i><span>السنوات الأكاديمية</span></a></li>
                    <?php endif; ?>
                    <?php if($isFull || $u->hasPermission('manage.tutoring-groups')): ?>
                    <li><a href="<?php echo e(route('admin.tutoring-groups.index', 'individual')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.tutoring-groups.*') && request()->route('type') === 'individual' ? 'active' : ''); ?>"><i class="fas fa-user"></i><span>المجموعات الفردية</span></a></li>
                    <li><a href="<?php echo e(route('admin.tutoring-groups.index', 'collective')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.tutoring-groups.*') && request()->route('type') === 'collective' ? 'active' : ''); ?>"><i class="fas fa-users"></i><span>المجموعات الجماعية</span></a></li>
                    <li><a href="<?php echo e(route('admin.tutor-work-schedules.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.tutor-work-schedules.*') ? 'active' : ''); ?>"><i class="fas fa-calendar-week"></i><span>جداول عمل المدربين</span></a></li>
                    <li><a href="<?php echo e(route('admin.tutoring-group-bookings.index')); ?>" class="sidebar-sub-link <?php echo e(request()->routeIs('admin.tutoring-group-bookings.*') ? 'active' : ''); ?>"><i class="fas fa-calendar-check"></i><span>حجوزات المجموعات</span></a></li>
                    <?php endif; ?>
