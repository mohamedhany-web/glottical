...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="domain" value="<?php echo e(old('domain')); ?>" required class="w-full rounded-lg border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white" placeholder="live.Glottical.com">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\admin\live-servers\create.blade.php ENDPATH**/ ?>