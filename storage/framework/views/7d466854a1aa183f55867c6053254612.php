...
<head>
  ...
  <title><?php echo e(__($g.'.catalog_group_title')); ?> — <?php echo e($brand); ?></title>
  <meta name="description" content="<?php echo e(__($g.'.catalog_group_desc')); ?>">
  <meta name="theme-color" content="#0B3D91">
  <link rel="canonical" href="<?php echo e(route('public.groups.courses')); ?>">
  ...
  <section class="sana-cat-hero">
    <div class="sana-container sana-cat-hero__inner sana-reveal">
      <div class="sana-cat-hero__breadcrumb">
        ...
        <span>/</span>
        <span><?php echo e(__($g.'.catalog_group_title')); ?></span>
      </div>
      <h1 class="sana-cat-hero__title">
        <?php echo e(__($g.'.catalog_group_title')); ?>

        <span class="hl"><?php echo e($isRtl ? 'مع المدرّس' : 'with tutor'); ?></span>
      </h1>
      <p class="sana-cat-hero__desc"><?php echo e(__($g.'.catalog_group_desc')); ?></p>
      <p class="sana-cat-hero__stats">
        <span class="sana-cat-hero__stat"><i class="fas fa-users"></i> <?php echo e($countLabel); ?></span>
  ...
  <div class="sana-container gl-gc-body">
        ...
        <?php $__currentLoopData = $groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <a href="<?php echo e(route('public.groups.show', $item->slug)); ?>" class="gl-gc-card">
            <div class="gl-gc-card__media">
              ...
              <span class="gl-gc-card__badge"><i class="fas fa-users"></i> <?php echo e($isRtl ? 'جماعي' : 'Group'); ?></span>
            </div>
            <div class="gl-gc-card__body">
              ...
              <p class="gl-gc-card__meta"><i class="fas fa-clock"></i> <?php echo e($item->duration_minutes); ?> <?php echo e($isRtl ? 'دقيقة' : 'min'); ?> · <?php echo e($isRtl ? 'سعة' : 'seats'); ?> <?php echo e($item->capacity); ?></p>
    ...
    <?php else: ?>
      <div class="gl-gc-empty sana-reveal">
        <p><?php echo e(__($g.'.empty_group')); ?></p>
    ...
    <div class="gl-gc-band sana-reveal">
      <div class="gl-gc-band__inner">
        <div>
          ...
          <p><?php echo e(__($g.'.catalog_group_cta_sub')); ?></p>
        </div>
        <div class="gl-gc-band__actions">
          ...
          <a href="<?php echo e(route('public.groups.one-to-one')); ?>" class="sana-btn sana-btn--wa"><i class="fas fa-user"></i> <?php echo e(__($g.'.view_all_solo')); ?></a>
...
<?php /**PATH C:\xampp\htdocs\glottical\resources\views\public\groups-courses.blade.php ENDPATH**/ ?>