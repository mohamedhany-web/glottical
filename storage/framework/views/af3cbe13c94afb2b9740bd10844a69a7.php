...
<a href="<?php echo e(route('home')); ?>" class="inline-flex items-center gap-3 group <?php echo e($mb); ?>">
    <?php if($logoUrl): ?>
        <div class="<?php echo e($box); ?> rounded-xl flex items-center justify-center overflow-hidden <?php echo e($logoWrap); ?> group-hover:brightness-110 transition-all">
            <img src="<?php echo e($logoUrl); ?>" alt="<?php echo e(config('app.name')); ?>" class="w-full h-full object-contain p-1" width="48" height="48" loading="eager" decoding="async" fetchpriority="high" onerror="this.onerror=null;this.src='<?php echo e(\App\Services\AdminPanelBranding::inlineFallbackDataUri()); ?>';">
        </div>
    ...
    <?php else: ?>
        <div class="<?php echo e($box); ?> rounded-xl <?php echo e($isDark ? 'bg-gradient-to-br from-acad-yellow to-amber-400' : 'bg-[#FB5607]'); ?> flex items-center justify-center shadow-lg <?php echo e($isDark ? 'shadow-black/30' : 'shadow-orange-500/25'); ?> group-hover:opacity-95 transition-opacity">
            <span class="text-<?php echo e($isDark ? '[#0B3D91]' : 'white'); ?> font-black <?php echo e($mText); ?>">G</span>
        </div>
    <?php endif; ?>
    <span class="<?php echo e($nameClass); ?> <?php echo e($brandText); ?>" <?php if($isSm): ?> style="font-family:Tajawal,sans-serif" <?php endif; ?>><?php echo e(config('app.name')); ?></span>
</a>
