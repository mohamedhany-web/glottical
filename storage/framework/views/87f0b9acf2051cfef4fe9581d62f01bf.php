        ...
        <div class="space-y-6">
            <div class="bg-gradient-to-br from-emerald-50 to-white rounded-xl border border-emerald-200 p-6 shadow-sm">
                ...
                <?php if($order->sales_contacted_at): ?>
                    <p class="text-xs text-gray-500 mt-3">آخر نشاط مسجل: <?php echo e(optional($order->sales_contacted_at)->format('Y-m-d H:i') ?? $order->sales_contacted_at); ?></p>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('layouts.employee', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\employee\sales\order-show.blade.php ENDPATH**/ ?>