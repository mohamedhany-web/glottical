    ...
    <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2">
                ...
                <?php if($employee->isSalesDepartmentEmployee()): ?>
                <a href="<?php echo e(route('admin.crm.sales-permissions.edit', $employee)); ?>" class="px-4 py-2 bg-violet-600 hover:bg-violet-700 text-white rounded-lg font-medium transition-colors">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\admin\employees\show.blade.php ENDPATH**/ ?>