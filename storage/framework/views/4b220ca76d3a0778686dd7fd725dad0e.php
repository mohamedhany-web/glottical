<?php $__env->startSection('title', ($pageTitle ?? 'إدارة المستخدمين') . ' - ' . config('app.name')); ?>
    ...
    <section class="students-card">
        ...
        <div class="p-5 grid grid-cols-1 md:grid-cols-3 gap-3">
            <?php if(Route::has('admin.tutoring-groups.index')): ?>
                <a href="<?php echo e(route('admin.tutoring-groups.index', 'individual')); ?>" class="inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-accent text-white font-semibold hover:opacity-90 transition-colors">
                    <i class="fas fa-user"></i>
                    مجموعات فردية
                </a>
                <a href="<?php echo e(route('admin.tutoring-groups.index', 'collective')); ?>" class="inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-600 text-slate-700 dark:text-slate-200 font-semibold hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
                    <i class="fas fa-users"></i>
                    مجموعات جماعية
                </a>
            <?php endif; ?>
            <?php if(Route::has('admin.advanced-courses.index')): ?>
                <a href="<?php echo e(route('admin.advanced-courses.index')); ?>" class="inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-600 text-slate-700 dark:text-slate-200 font-semibold hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\glottical\resources\views\admin\users\index.blade.php ENDPATH**/ ?>