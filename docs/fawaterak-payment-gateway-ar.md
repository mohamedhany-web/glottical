...
هذا المستند يشرح **كل ما يخص بوابة الدفع فواتيرك في مشروع Glottical**: الإعدادات، المسارات (Routes)، تدفق الدفع للكورسات والاشتراكات، وما الذي يُحفظ في الجلسة وقاعدة البيانات، وكيف يتم اعتماد الطلب وإنشاء الفاتورة محلياً بعد العودة من فواتيرك.
