...
class ClassroomMeetingRoomNameTest extends TestCase
{
    ...
    public function test_jitsi_room_name_prefers_stored_room_name(): void
    {
        ...
        $this->assertSame('tutoring-9-legacy', $meeting->jitsiRoomName());
    }

    public function test_jitsi_room_name_falls_back_to_canonical(): void
    {
        $meeting = new ClassroomMeeting([
            'code' => 'ABCDEFGH',
            'room_name' => null,
        ...
        $this->assertSame('Glottical-ABCDEFGH', $meeting->jitsiRoomName());
    }
}
