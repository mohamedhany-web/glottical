...
@section('title', 'الواجبات - ' . config('app.name'))
@section('page_title', 'الواجبات')

@section('content')
<div class="space-y-5">
    <section class="flex flex-wrap items-end justify-between gap-4">
        <div class="min-w-0">
            <p class="text-xs font-medium text-muted">المحتوى · الواجبات والمشاريع</p>
            <h2 class="mt-1 text-2xl font-semibold tracking-tight text-ink md:text-[28px]">إدارة الواجبات</h2>
            <p class="mt-1 max-w-2xl text-sm text-muted">اختر برنامجاً لعرض واجباته وتسليمات الطلاب.</p>
        </div>
    </section>
    ...
    @else
        <article class="rounded-2xl border border-dashed border-line bg-surface px-6 py-14 text-center shadow-soft">
            ...
            <p class="mt-1 text-sm text-muted">أضف برنامجاً أولاً ثم أنشئ واجباته.</p>
        </article>
    @endif
</div>
@endsection
