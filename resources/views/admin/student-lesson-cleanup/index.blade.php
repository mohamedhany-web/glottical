...
<div class="space-y-5">
    ...
    {{-- Outside the table so row delete forms are NOT nested (nested forms caused 405 on /bulk). --}}
                ...
                <tbody class="divide-y divide-slate-100">
                    @forelse($rows as $row)
                        <tr class="hover:bg-slate-50/70">
                            <td class="px-3 py-3">
                                <input type="checkbox" form="cleanup-bulk-form" name="ids[]" value="{{ $row->id }}" class="cleanup-row-check rounded border-slate-300">
                            </td>
