                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-2 md:col-span-2">
                                    ...
                                    <select name="delivery_type" class="w-full rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-700 px-4 py-3 text-slate-800 dark:text-slate-200">
                                        <option value="group" @selected(old('delivery_type', $advancedCourse->delivery_type ?? 'group') === 'group')>جماعي</option>
                                        <option value="one_to_one" @selected(old('delivery_type', $advancedCourse->delivery_type ?? 'group') === 'one_to_one')>فردي 1:1 مع معلم</option>
                                    </select>
                            ...
                            <div class="space-y-2">
                                ...
                                @if($advancedCourse->thumbnail_url)
                                    <div class="mb-3 space-y-2">
                                        <img src="{{ $advancedCourse->thumbnail_url }}" alt="صورة الكورس الحالية"
                                        ...
                                        @if(!\App\Services\CourseThumbnailStorage::isExternalUrl($advancedCourse->thumbnail))
                                            <p class="text-xs text-slate-400">المسار المحفوظ: {{ $advancedCourse->thumbnail }}</p>
                                        @endif
                                    </div>
                                @endif
