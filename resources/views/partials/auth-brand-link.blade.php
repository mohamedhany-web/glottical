...
<a href="{{ route('home') }}" class="inline-flex items-center gap-3 group {{ $mb }}">
    ...
    @else
        <div class="{{ $box }} flex items-center justify-center rounded-xl bg-accent text-white shadow-[0_10px_24px_rgba(75,58,120,0.28)] transition group-hover:bg-[#3A2C5C]">
