...
<head>
  ...
  <style>
    ...
    .gl-auth-bg {
      ...
      background:
        radial-gradient(ellipse 70% 50% at 92% -8%, rgba(75,58,120,.16), transparent 55%),
        radial-gradient(ellipse 50% 40% at -8% 100%, rgba(255,183,165,.14), transparent 50%),
        #FFFBE6;
    }
    .gl-auth-bg__dot {
      position: absolute; inset: 0; opacity: .4;
      background-image: radial-gradient(rgba(75,58,120,.14) 1px, transparent 1px);
    ...
    .gl-auth-lang a.is-on { background: #4B3A78; color: #fff; }
    .gl-auth-nav-link {
      font: 800 .8rem Tajawal, sans-serif; color: #4B3A78; text-decoration: none !important;
      padding: .45rem .7rem; border-radius: 10px;
    }
    .gl-auth-nav-link:hover { background: #F3E9FF; }
    .gl-auth-main {
    ...
    .gl-auth-card {
      ...
      border: 1.5px solid #E8DFC8; border-radius: 20px;
      padding: 1.35rem 1.25rem 1.4rem;
      box-shadow: 0 18px 48px -24px rgba(75,58,120,.35);
    }
    .gl-auth-card--wide { max-width: 520px; }
    .gl-auth-brand {
      text-align: center; margin-bottom: .85rem;
      font-family: Cairo, Tajawal, sans-serif; font-weight: 900; font-size: 1.25rem; color: #4B3A78;
    }
    .gl-auth-title {
      margin: 0 0 .35rem; text-align: center;
      font-family: Cairo, Tajawal, sans-serif; font-weight: 900;
      font-size: clamp(1.35rem, 3.5vw, 1.7rem); line-height: 1.35; color: #2E234A;
    }
    .gl-auth-title em { color: #4B3A78; font-style: normal; }
    .gl-auth-lead {
    ...
    .gl-auth-alert--warn { background: #FFFBE6; color: #9A7200; }
    .gl-auth-alert--err { background: #FEF2F2; color: #B91C1C; }
    .gl-auth-alert--info { background: #F3E9FF; color: #4B3A78; }
    .gl-auth-field { margin-bottom: .9rem; }
    .gl-auth-field label {
      display: block; margin-bottom: .35rem;
      font: 800 .78rem Tajawal, sans-serif; color: #2E234A;
    }
    .gl-auth-input-wrap { position: relative; }
    .gl-auth-input {
      width: 100%; height: 3rem; box-sizing: border-box;
      border: 1.5px solid #E8DFC8; border-radius: 12px;
      padding: 0 2.75rem 0 1rem; background: #FFFBE6;
      font: 600 .92rem Tajawal, sans-serif; color: #2E234A;
    ...
    .gl-auth-pw-btn:hover { background: #F3E9FF; color: #4B3A78; }
    ...
    .gl-auth-phone > input[type="tel"] {
      width: 100%; height: 3rem; box-sizing: border-box;
      border: 1.5px solid #E8DFC8; border-radius: 12px; background: #FFFBE6;
      padding: 0 .85rem; font: 600 .88rem Tajawal, sans-serif; color: #2E234A; outline: none;
    }
    ...
    .gl-auth-cc-btn {
      ...
      font: 600 .82rem Tajawal, sans-serif; color: #2E234A; text-align: start;
    }
    .gl-auth-cc-btn:hover,
    .gl-auth-cc-btn:focus-visible {
      border-color: #4B3A78; background: #fff;
      box-shadow: 0 0 0 3px rgba(75,58,120,.12); outline: none;
    }
    .gl-auth-cc-dial { flex: 0 0 auto; font-weight: 800; color: #4B3A78; white-space: nowrap; }
    .gl-auth-cc-name {
    ...
    .gl-auth-cc-panel {
      ...
      border: 1.5px solid #E8DFC8; border-radius: 14px; background: #fff;
    ...
    .gl-auth-cc-search input {
      ...
      font: 600 .82rem Tajawal, sans-serif; color: #2E234A; height: 1.8rem;
    }
    .gl-auth-cc-list {
    ...
    .gl-auth-cc-option {
      ...
      font: 600 .82rem Tajawal, sans-serif; color: #2E234A;
    }
    .gl-auth-cc-option:hover,
    .gl-auth-cc-option.is-active { background: #EAF0FA; }
    .gl-auth-cc-option-dial { flex: 0 0 3.4rem; font-weight: 800; color: #4B3A78; }
    ...
    .gl-auth-check input { accent-color: #4B3A78; width: 1rem; height: 1rem; }
    .gl-auth-link {
      font: 800 .78rem Tajawal, sans-serif; color: #4B3A78; text-decoration: none !important;
    }
    ...
    .gl-auth-terms input { margin-top: .2rem; accent-color: #4B3A78; flex-shrink: 0; }
    .gl-auth-submit {
      width: 100%; min-height: 3.1rem; border: 0; border-radius: 999px; cursor: pointer;
      display: inline-flex; align-items: center; justify-content: center; gap: .5rem;
      background: linear-gradient(135deg, #FFB7A5, #F59A84); color: #3A2C5C;
      font: 900 .95rem Cairo, Tajawal, sans-serif;
      box-shadow: 0 10px 28px rgba(255,183,165,.4);
    }
    ...
    .gl-auth-or::before, .gl-auth-or::after {
      content: ""; flex: 1; height: 1px; background: #F3E9FF;
    }
    .gl-auth-google {
    ...
    .gl-auth-foot {
      margin-top: 1.15rem; padding-top: 1rem; border-top: 1px solid #F3E9FF;
