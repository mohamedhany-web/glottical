...
@include('partials.student-timeline-top', [
    ...
    'crumbs' => [
        ...
        ['label' => __('student_timeline.lib_files_title'), 'url' => route('student.library.files', ['tab' => 'materials'])],
...
<section class="st-xp-shell">
    <div class="st-xp-head">
        ...
        <div class="st-xp-actions">
            <a href="{{ route('student.library.files', ['tab' => 'materials']) }}" class="st-pill st-pill--outline">{{ __('student_timeline.back_to_materials') }}</a>
