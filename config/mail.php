...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | إرسال نسخة بريدية لكل إشعار داخل المنصة
    |--------------------------------------------------------------------------
    |
    | عند التفعيل تُرسل نسخة إلى بريد المستخدم (مثل Gmail) مع كل إشعار جديد.
    |
    */
    'notify_in_app' => filter_var(env('MAIL_NOTIFY_IN_APP', true), FILTER_VALIDATE_BOOLEAN),
